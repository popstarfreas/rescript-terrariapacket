...
import type { t as Lazy_t } from '../src/shims/Lazy.shim.mts';

import type { t as Packet_ActiveContainerSync_t } from '../src/packet/Packet_ActiveContainerSync.gen.ts';

import type { t as Packet_AnglerQuestComplete_t } from '../src/packet/Packet_AnglerQuestComplete.gen.ts';

import type { t as Packet_AnglerQuest_t } from '../src/packet/Packet_AnglerQuest.gen.ts';

import type { t as Packet_AnglerQuestsCompletedAmount_t } from '../src/packet/Packet_AnglerQuestsCompletedAmount.gen.ts';

import type { t as Packet_BossOrInvasionSpawn_t } from '../src/packet/Packet_BossOrInvasionSpawn.gen.ts';

import type { t as Packet_CavernMonsterTypeSync_t } from '../src/packet/Packet_CavernMonsterTypeSync.gen.ts';

import type { t as Packet_ChatMessageSmart_t } from '../src/packet/Packet_ChatMessageSmart.gen.ts';

import type { t as Packet_ChestItem_t } from '../src/packet/Packet_ChestItem.gen.ts';

import type { t as Packet_ChestName_t } from '../src/packet/Packet_ChestName.gen.ts';

import type { t as Packet_ChestOpen_t } from '../src/packet/Packet_ChestOpen.gen.ts';

import type { t as Packet_ChestOrTempleUnlock_t } from '../src/packet/Packet_ChestOrTempleUnlock.gen.ts';

import type { t as Packet_ChestPlace_t } from '../src/packet/Packet_ChestPlace.gen.ts';

import type { t as Packet_ClientFinishConnectingToServer_t } from '../src/packet/Packet_ClientFinishConnectingToServer.gen.ts';

import type { t as Packet_ClientSyncedInventory_t } from '../src/packet/Packet_ClientSyncedInventory.gen.ts';

import type { t as Packet_ClientUuid_t } from '../src/packet/Packet_ClientUuid.gen.ts';

import type { t as Packet_CombatNumberCreate_t } from '../src/packet/Packet_CombatNumberCreate.gen.ts';

import type { t as Packet_CombatTextCreate_t } from '../src/packet/Packet_CombatTextCreate.gen.ts';

import type { t as Packet_ConnectRequest_t } from '../src/packet/Packet_ConnectRequest.gen.ts';

import type { t as Packet_CountsAsHostForGameplaySet_t } from '../src/packet/Packet_CountsAsHostForGameplaySet.gen.ts';

import type { t as Packet_CreditsOrSlimeTransform_t } from '../src/packet/Packet_CreditsOrSlimeTransform.gen.ts';

import type { t as Packet_CrystalInvasionSendWaitTime_t } from '../src/packet/Packet_CrystalInvasionSendWaitTime.gen.ts';

import type { t as Packet_CrystalInvasionStart_t } from '../src/packet/Packet_CrystalInvasionStart.gen.ts';

import type { t as Packet_CrystalInvasionWipeAll_t } from '../src/packet/Packet_CrystalInvasionWipeAll.gen.ts';

import type { t as Packet_DimensionsUpdate_t } from '../src/packet/Packet_DimensionsUpdate.gen.ts';

import type { t as Packet_Disconnect_t } from '../src/packet/Packet_Disconnect.gen.ts';

import type { t as Packet_DoorUse_t } from '../src/packet/Packet_DoorUse.gen.ts';

import type { t as Packet_DungeonDefendersEventAttemptSkipWait_t } from '../src/packet/Packet_DungeonDefendersEventAttemptSkipWait.gen.ts';

import type { t as Packet_Emoji_t } from '../src/packet/Packet_Emoji.gen.ts';

import type { t as Packet_EmoteBubble_t } from '../src/packet/Packet_EmoteBubble.gen.ts';

import type { t as Packet_EventNotification_t } from '../src/packet/Packet_EventNotification.gen.ts';

import type { t as Packet_ExtraValueSync_t } from '../src/packet/Packet_ExtraValueSync.gen.ts';

import type { t as Packet_FoodPlatterTryPlacing_t } from '../src/packet/Packet_FoodPlatterTryPlacing.gen.ts';

import type { t as Packet_GemLockToggle_t } from '../src/packet/Packet_GemLockToggle.gen.ts';

import type { t as Packet_GolfBallLandInCup_t } from '../src/packet/Packet_GolfBallLandInCup.gen.ts';

import type { t as Packet_GoodEvilUpdate_t } from '../src/packet/Packet_GoodEvilUpdate.gen.ts';

import type { t as Packet_HarpPlay_t } from '../src/packet/Packet_HarpPlay.gen.ts';

import type { t as Packet_HaveDryadDoStardewAnimation_t } from '../src/packet/Packet_HaveDryadDoStardewAnimation.gen.ts';

import type { t as Packet_HealEffect_t } from '../src/packet/Packet_HealEffect.gen.ts';

import type { t as Packet_InitialTileSectionsRequest_t } from '../src/packet/Packet_InitialTileSectionsRequest.gen.ts';

import type { t as Packet_InvasionProgressReport_t } from '../src/packet/Packet_InvasionProgressReport.gen.ts';

import type { t as Packet_ItemDropInstancedUpdate_t } from '../src/packet/Packet_ItemDropInstancedUpdate.gen.ts';

import type { t as Packet_ItemDropModify_t } from '../src/packet/Packet_ItemDropModify.gen.ts';

import type { t as Packet_ItemDropProtectedUpdate_t } from '../src/packet/Packet_ItemDropProtectedUpdate.gen.ts';

import type { t as Packet_ItemDropShimmeredUpdate_t } from '../src/packet/Packet_ItemDropShimmeredUpdate.gen.ts';

import type { t as Packet_ItemDropUpdate_t } from '../src/packet/Packet_ItemDropUpdate.gen.ts';

import type { t as Packet_ItemForceIntoNearestChest_t } from '../src/packet/Packet_ItemForceIntoNearestChest.gen.ts';

import type { t as Packet_ItemFramePlace_t } from '../src/packet/Packet_ItemFramePlace.gen.ts';

import type { t as Packet_ItemOwnerRemove_t } from '../src/packet/Packet_ItemOwnerRemove.gen.ts';

import type { t as Packet_ItemOwner_t } from '../src/packet/Packet_ItemOwner.gen.ts';

import type { t as Packet_LegacySoundPlay_t } from '../src/packet/Packet_LegacySoundPlay.gen.ts';

import type { t as Packet_LiquidSet_t } from '../src/packet/Packet_LiquidSet.gen.ts';

import type { t as Packet_LoadoutSwitch_t } from '../src/packet/Packet_LoadoutSwitch.gen.ts';

import type { t as Packet_LucyAxeMessage_t } from '../src/packet/Packet_LucyAxeMessage.gen.ts';

import type { t as Packet_ManaEffect_t } from '../src/packet/Packet_ManaEffect.gen.ts';

import type { t as Packet_MassWireOperationPay_t } from '../src/packet/Packet_MassWireOperationPay.gen.ts';

import type { t as Packet_MassWireOperation_t } from '../src/packet/Packet_MassWireOperation.gen.ts';

import type { t as Packet_MinionAttackTargetUpdate_t } from '../src/packet/Packet_MinionAttackTargetUpdate.gen.ts';

import type { t as Packet_MinionTargetUpdate_t } from '../src/packet/Packet_MinionTargetUpdate.gen.ts';

import type { t as Packet_MoonLordCountdown_t } from '../src/packet/Packet_MoonLordCountdown.gen.ts';

import type { t as Packet_NebulaLevelUp_t } from '../src/packet/Packet_NebulaLevelUp.gen.ts';

import type { t as Packet_NetModuleLoad_t } from '../src/packet/Packet_NetModuleLoad.gen.ts';

import type { t as Packet_NpcBuffAdd_t } from '../src/packet/Packet_NpcBuffAdd.gen.ts';

import type { t as Packet_NpcBuffRemovalRequest_t } from '../src/packet/Packet_NpcBuffRemovalRequest.gen.ts';

import type { t as Packet_NpcBuffUpdate_t } from '../src/packet/Packet_NpcBuffUpdate.gen.ts';

import type { t as Packet_NpcCatch_t } from '../src/packet/Packet_NpcCatch.gen.ts';

import type { t as Packet_NpcFishOut_t } from '../src/packet/Packet_NpcFishOut.gen.ts';

import type { t as Packet_NpcHomeUpdate_t } from '../src/packet/Packet_NpcHomeUpdate.gen.ts';

import type { t as Packet_NpcItemStrike_t } from '../src/packet/Packet_NpcItemStrike.gen.ts';

import type { t as Packet_NpcKillCount_t } from '../src/packet/Packet_NpcKillCount.gen.ts';

import type { t as Packet_NpcKilledNotification_t } from '../src/packet/Packet_NpcKilledNotification.gen.ts';

import type { t as Packet_NpcNameUpdate_t } from '../src/packet/Packet_NpcNameUpdate.gen.ts';

import type { t as Packet_NpcRelease_t } from '../src/packet/Packet_NpcRelease.gen.ts';

import type { t as Packet_NpcShopItem_t } from '../src/packet/Packet_NpcShopItem.gen.ts';

import type { t as Packet_NpcSpecialEffect_t } from '../src/packet/Packet_NpcSpecialEffect.gen.ts';

import type { t as Packet_NpcStrike_t } from '../src/packet/Packet_NpcStrike.gen.ts';

import type { t as Packet_NpcTalk_t } from '../src/packet/Packet_NpcTalk.gen.ts';

import type { t as Packet_NpcTamper_t } from '../src/packet/Packet_NpcTamper.gen.ts';

import type { t as Packet_NpcTeleportPortal_t } from '../src/packet/Packet_NpcTeleportPortal.gen.ts';

import type { t as Packet_NpcUpdate_t } from '../src/packet/Packet_NpcUpdate.gen.ts';

import type { t as Packet_ObjectPlace_t } from '../src/packet/Packet_ObjectPlace.gen.ts';

import type { t as Packet_PartyToggle_t } from '../src/packet/Packet_PartyToggle.gen.ts';

import type { t as Packet_PasswordRequired_t } from '../src/packet/Packet_PasswordRequired.gen.ts';

import type { t as Packet_PasswordSend_t } from '../src/packet/Packet_PasswordSend.gen.ts';

import type { t as Packet_PiggyBankVoidLensUpdate_t } from '../src/packet/Packet_PiggyBankVoidLensUpdate.gen.ts';

import type { t as Packet_PlayerActive_t } from '../src/packet/Packet_PlayerActive.gen.ts';

import type { t as Packet_PlayerAnimation_t } from '../src/packet/Packet_PlayerAnimation.gen.ts';

import type { t as Packet_PlayerBuffAdd_t } from '../src/packet/Packet_PlayerBuffAdd.gen.ts';

import type { t as Packet_PlayerBuffsSet_t } from '../src/packet/Packet_PlayerBuffsSet.gen.ts';

import type { t as Packet_PlayerChestIndexSync_t } from '../src/packet/Packet_PlayerChestIndexSync.gen.ts';

import type { t as Packet_PlayerDamage_t } from '../src/packet/Packet_PlayerDamage.gen.ts';

import type { t as Packet_PlayerDead_t } from '../src/packet/Packet_PlayerDead.gen.ts';

import type { t as Packet_PlayerDeath_t } from '../src/packet/Packet_PlayerDeath.gen.ts';

import type { t as Packet_PlayerDodge_t } from '../src/packet/Packet_PlayerDodge.gen.ts';

import type { t as Packet_PlayerHealOther_t } from '../src/packet/Packet_PlayerHealOther.gen.ts';

import type { t as Packet_PlayerHealth_t } from '../src/packet/Packet_PlayerHealth.gen.ts';

import type { t as Packet_PlayerInfo_t } from '../src/packet/Packet_PlayerInfo.gen.mts';

import type { t as Packet_PlayerInventorySlot_t } from '../src/packet/Packet_PlayerInventorySlot.gen.ts';

import type { t as Packet_PlayerLuckFactorsUpdate_t } from '../src/packet/Packet_PlayerLuckFactorsUpdate.gen.ts';

import type { t as Packet_PlayerMana_t } from '../src/packet/Packet_PlayerMana.gen.ts';

import type { t as Packet_PlayerSlotSet_t } from '../src/packet/Packet_PlayerSlotSet.gen.ts';

import type { t as Packet_PlayerSpawnSelf_t } from '../src/packet/Packet_PlayerSpawnSelf.gen.ts';

import type { t as Packet_PlayerSpawn_t } from '../src/packet/Packet_PlayerSpawn.gen.ts';

import type { t as Packet_PlayerStealth_t } from '../src/packet/Packet_PlayerStealth.gen.ts';

import type { t as Packet_PlayerTeam_t } from '../src/packet/Packet_PlayerTeam.gen.ts';

import type { t as Packet_PlayerTeleportPortal_t } from '../src/packet/Packet_PlayerTeleportPortal.gen.ts';

import type { t as Packet_PlayerUpdate_t } from '../src/packet/Packet_PlayerUpdate.gen.ts';

import type { t as Packet_PortalKill_t } from '../src/packet/Packet_PortalKill.gen.ts';

import type { t as Packet_ProjectileDestroy_t } from '../src/packet/Packet_ProjectileDestroy.gen.ts';

import type { t as Packet_ProjectileSync_t } from '../src/packet/Packet_ProjectileSync.gen.ts';

import type { t as Packet_PvpToggle_t } from '../src/packet/Packet_PvpToggle.gen.ts';

import type { t as Packet_RevengeMarkerRemove_t } from '../src/packet/Packet_RevengeMarkerRemove.gen.ts';

import type { t as Packet_RevengeMarkerSync_t } from '../src/packet/Packet_RevengeMarkerSync.gen.ts';

import type { t as Packet_ShieldStrengthsUpdate_t } from '../src/packet/Packet_ShieldStrengthsUpdate.gen.ts';

import type { t as Packet_ShimmerEffectOrCoinLuck_t } from '../src/packet/Packet_ShimmerEffectOrCoinLuck.gen.ts';

import type { t as Packet_SignNew_t } from '../src/packet/Packet_SignNew.gen.ts';

import type { t as Packet_SignRead_t } from '../src/packet/Packet_SignRead.gen.ts';

import type { t as Packet_SmokePoof_t } from '../src/packet/Packet_SmokePoof.gen.ts';

import type { t as Packet_SocialHandshake_t } from '../src/packet/Packet_SocialHandshake.gen.ts';

import type { t as Packet_Status_t } from '../src/packet/Packet_Status.gen.ts';

import type { t as Packet_SwitchHit_t } from '../src/packet/Packet_SwitchHit.gen.ts';

import type { t as Packet_Teleport_t } from '../src/packet/Packet_Teleport.gen.ts';

import type { t as Packet_TeleportationPotion_t } from '../src/packet/Packet_TeleportationPotion.gen.ts';

import type { t as Packet_TemporaryAnimationCreate_t } from '../src/packet/Packet_TemporaryAnimationCreate.gen.ts';

import type { t as Packet_TileEntityDisplayDollItemSync_t } from '../src/packet/Packet_TileEntityDisplayDollItemSync.gen.ts';

import type { t as Packet_TileEntityHatRackItemSync_t } from '../src/packet/Packet_TileEntityHatRackItemSync.gen.ts';

import type { t as Packet_TileEntityInteractionRequest_t } from '../src/packet/Packet_TileEntityInteractionRequest.gen.ts';

import type { t as Packet_TileEntityPlace_t } from '../src/packet/Packet_TileEntityPlace.gen.ts';

import type { t as Packet_TileEntityUpdate_t } from '../src/packet/Packet_TileEntityUpdate.gen.ts';

import type { t as Packet_TileModify_t } from '../src/packet/Packet_TileModify.gen.ts';

import type { t as Packet_TilePaint_t } from '../src/packet/Packet_TilePaint.gen.ts';

import type { t as Packet_TilePickingSync_t } from '../src/packet/Packet_TilePickingSync.gen.ts';

import type { t as Packet_TileSectionFrame_t } from '../src/packet/Packet_TileSectionFrame.gen.ts';

import type { t as Packet_TileSectionSend_t } from '../src/packet/Packet_TileSectionSend.gen.ts';

import type { t as Packet_TileSquareSend_t } from "../src/packet/Packet_TileSquareSend.gen.mts";

import type { t as Packet_TimeSet_t } from '../src/packet/Packet_TimeSet.gen.ts';

import type { t as Packet_TravellingMerchantInventory_t } from '../src/packet/Packet_TravellingMerchantInventory.gen.ts';

import type { t as Packet_TreeGrowFx_t } from '../src/packet/Packet_TreeGrowFx.gen.ts';

import type { t as Packet_Unused_t } from '../src/packet/Packet_Unused.gen.ts';

import type { t as Packet_WallPaint_t } from "../src/packet/Packet_WallPaint.gen.mts";

import type { t as Packet_WeaponsRackTryPlacing_t } from '../src/packet/Packet_WeaponsRackTryPlacing.gen.ts';

import type { t as Packet_WiredCannonShot_t } from '../src/packet/Packet_WiredCannonShot.gen.ts';

import type { t as Packet_WorldDataRequest_t } from '../src/packet/Packet_WorldDataRequest.gen.ts';

import type { t as Packet_WorldInfo_t } from '../src/packet/Packet_WorldInfo.gen.mts';

import type { t as Packet_Zones_t } from '../src/packet/Packet_Zones.gen.ts';
...
export type t =
    ...
    | { TAG: "NetModuleLoad"; _0: Packet_NetModuleLoad_t }
...
export type LazyPacket_t =
    ...
    | { TAG: "NetModuleLoad"; _0: Lazy_t<(undefined | Packet_NetModuleLoad_t)> }

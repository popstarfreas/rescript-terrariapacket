...
/* TypeScript file generated from Packet_TileEntityUpdate.res by genType. */

/* eslint-disable */
/* tslint:disable */

export type payload = "Remove" | { TAG: "Data"; _0: Buffer };

export type t = { readonly tileEntityId: number; readonly payload: payload };

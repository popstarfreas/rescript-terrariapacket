...
function readEventInfo(reader) {
  ...
  let vampireSeed = BitFlags$TerrariaPacket.flag4(eventInfo10);
  let infectedSeed = BitFlags$TerrariaPacket.flag5(eventInfo10);
  let teamBasedSpawnsSeed = BitFlags$TerrariaPacket.flag6(eventInfo10);
  let skyblockWorld = BitFlags$TerrariaPacket.flag7(eventInfo10);
  let dualDungeonsSeed = BitFlags$TerrariaPacket.flag8(eventInfo10);
  return {
    TAG: "Ok",
    _0: {
...
function parse(payload) {
  ...
  let e$63 = ErrorAwarePacketReader$TerrariaPacket.readByte(reader, "worldFlags");
  if (e$63.TAG !== "Ok") {
    return e$63;
  }
  let worldFlags = BitFlags$TerrariaPacket.fromByte(e$63._0);
  let lowTiles = BitFlags$TerrariaPacket.flag1(worldFlags);
  let forceHalloweenForever = BitFlags$TerrariaPacket.flag2(worldFlags);
  let forceChristmasForever = BitFlags$TerrariaPacket.flag3(worldFlags);
  let moreLightningSeed = BitFlags$TerrariaPacket.flag4(worldFlags);
  let noLightningSeed = BitFlags$TerrariaPacket.flag5(worldFlags);
  let e$64 = ErrorAwarePacketReader$TerrariaPacket.readByte(reader, "sundialCooldown");
  if (e$64.TAG !== "Ok") {
    return e$64;
  }
  let e$65 = ErrorAwarePacketReader$TerrariaPacket.readByte(reader, "moondialCooldown");
  if (e$65.TAG !== "Ok") {
    return e$65;
  }
  let e$66 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, "copperOreTier");
  if (e$66.TAG !== "Ok") {
    return e$66;
  }
  let e$67 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, "ironOreTier");
  if (e$67.TAG !== "Ok") {
    return e$67;
  }
  let e$68 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, "silverOreTier");
  if (e$68.TAG !== "Ok") {
    return e$68;
  }
  let e$69 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, "goldOreTier");
  if (e$69.TAG !== "Ok") {
    return e$69;
  }
  let e$70 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, "cobaltOreTier");
  if (e$70.TAG !== "Ok") {
    return e$70;
  }
  let e$71 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, "mythrilOreTier");
  if (e$71.TAG !== "Ok") {
    return e$71;
  }
  let e$72 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, "adamantiteOreTier");
  if (e$72.TAG !== "Ok") {
    return e$72;
  }
  let e$73 = ErrorAwarePacketReader$TerrariaPacket.readSByte(reader, "invasionType");
  if (e$73.TAG !== "Ok") {
    return e$73;
  }
  let e$74 = ErrorAwarePacketReader$TerrariaPacket.readUInt64(reader, "lobbyId");
  if (e$74.TAG !== "Ok") {
    return e$74;
  }
  let e$75 = ErrorAwarePacketReader$TerrariaPacket.readSingle(reader, "sandstormSeverity");
  if (e$75.TAG !== "Ok") {
    return e$75;
  }
  let e$76 = ErrorAwarePacketReader$TerrariaPacket.readByte(reader, "extraSpawnPointCount");
  if (e$76.TAG !== "Ok") {
    return e$76;
  }
  ...
  let readExtraSpawnPoints = _idx => {
    while (true) {
      ...
      let e = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, `extraSpawnPointX_` + idx.toString());
      if (e.TAG !== "Ok") {
        return e;
      }
      let e$1 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, `extraSpawnPointY_` + idx.toString());
      if (e$1.TAG !== "Ok") {
        return e$1;
      }
  ...
  let e$78 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, "dungeonX");
  if (e$78.TAG !== "Ok") {
    return e$78;
  }
  let e$79 = ErrorAwarePacketReader$TerrariaPacket.readInt16(reader, "dungeonY");
  if (e$79.TAG === "Ok") {
    return {
      TAG: "Ok",
      _0: {
...
function packEventInfo(writer, eventInfo) {
  ...
  let eventInfo10 = BitFlags$TerrariaPacket.fromFlags(eventInfo.noTrapsWorld, eventInfo.zenithWorld, eventInfo.unlockedTruffleSpawn, eventInfo.vampireSeed, eventInfo.infectedSeed, eventInfo.teamBasedSpawnsSeed, eventInfo.skyblockWorld, eventInfo.dualDungeonsSeed);
...
let Encode = {
  ...
  packExtraSpawnPoints: packExtraSpawnPoints,
  toBuffer: toBuffer
};

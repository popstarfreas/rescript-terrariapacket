...
function readEventInfo(reader) {
  ...
  var eventInfo9 = BitFlags$DarkgamingRescriptTerrariapacket.fromByte(reader.readByte());
  var eventInfo10 = BitFlags$DarkgamingRescriptTerrariapacket.fromByte(reader.readByte());
  ...
  var dontStarveWorld = BitFlags$DarkgamingRescriptTerrariapacket.flag2(eventInfo8);
  var downedDeerClops = BitFlags$DarkgamingRescriptTerrariapacket.flag3(eventInfo8);
  var notTheBeesWorld = BitFlags$DarkgamingRescriptTerrariapacket.flag4(eventInfo8);
  var remixWorld = BitFlags$DarkgamingRescriptTerrariapacket.flag5(eventInfo8);
  var unlockedSlimeBlueSpawn = BitFlags$DarkgamingRescriptTerrariapacket.flag6(eventInfo8);
  var combatBookVolumeTwoWasUsed = BitFlags$DarkgamingRescriptTerrariapacket.flag7(eventInfo8);
  var peddlersSatchelWasUsed = BitFlags$DarkgamingRescriptTerrariapacket.flag8(eventInfo8);
  var unlockedSlimeGreenSpawn = BitFlags$DarkgamingRescriptTerrariapacket.flag1(eventInfo9);
  var unlockedSlimeOldSpawn = BitFlags$DarkgamingRescriptTerrariapacket.flag2(eventInfo9);
  var unlockedSlimePurpleSpawn = BitFlags$DarkgamingRescriptTerrariapacket.flag3(eventInfo9);
  var unlockedSlimeRainbowSpawn = BitFlags$DarkgamingRescriptTerrariapacket.flag4(eventInfo9);
  var unlockedSlimeRedSpawn = BitFlags$DarkgamingRescriptTerrariapacket.flag5(eventInfo9);
  var unlockedSlimeYellowSpawn = BitFlags$DarkgamingRescriptTerrariapacket.flag6(eventInfo9);
  var unlockedSlimeCopperSpawn = BitFlags$DarkgamingRescriptTerrariapacket.flag7(eventInfo9);
  var fastForwardTimeToDusk = BitFlags$DarkgamingRescriptTerrariapacket.flag8(eventInfo9);
  var noTrapsWorld = BitFlags$DarkgamingRescriptTerrariapacket.flag1(eventInfo10);
  var zenithWorld = BitFlags$DarkgamingRescriptTerrariapacket.flag2(eventInfo10);
  var unlockedTruffleSpawn = BitFlags$DarkgamingRescriptTerrariapacket.flag3(eventInfo10);
  return {
...
function packEventInfo(writer, eventInfo) {
  ...
  var eventInfo8 = BitFlags$DarkgamingRescriptTerrariapacket.fromFlags(eventInfo.tenthAnniversaryWorld, eventInfo.dontStarveWorld, eventInfo.downedDeerClops, eventInfo.notTheBeesWorld, eventInfo.remixWorld, eventInfo.unlockedSlimeBlueSpawn, eventInfo.combatBookVolumeTwoWasUsed, eventInfo.peddlersSatchelWasUsed);
  var eventInfo9 = BitFlags$DarkgamingRescriptTerrariapacket.fromFlags(eventInfo.unlockedSlimeGreenSpawn, eventInfo.unlockedSlimeOldSpawn, eventInfo.unlockedSlimePurpleSpawn, eventInfo.unlockedSlimeRainbowSpawn, eventInfo.unlockedSlimeRedSpawn, eventInfo.unlockedSlimeYellowSpawn, eventInfo.unlockedSlimeCopperSpawn, eventInfo.fastForwardTimeToDusk);
  var eventInfo10 = BitFlags$DarkgamingRescriptTerrariapacket.fromFlags(eventInfo.noTrapsWorld, eventInfo.zenithWorld, eventInfo.unlockedTruffleSpawn, false, false, false, false, false);

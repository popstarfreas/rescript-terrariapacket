...
/* TypeScript file generated from Packet_MassWireOperationPay.res by genType. */

/* eslint-disable */
/* tslint:disable */

export type t = { readonly itemType: number; readonly stack: number; readonly playerId: number };

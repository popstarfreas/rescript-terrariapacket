...
var PacketWriter$PacketFactory = require("@popstarfreas/packetfactory/src/PacketWriter.js");
...
function packIntoBufferUnsafe(self, buffer) {
  return PacketWriter$PacketFactory.setType(new Dumbpacketwriter(buffer), PacketType$TerrariaPacket.toInt(/* ConnectRequest */0)).packString(self.version).packedLength;
}
...
function toBuffer(self) {
  return ManagedPacketWriter$PacketFactory.setType(new Packetwriter(), PacketType$TerrariaPacket.toInt(/* ConnectRequest */0)).packString(self.version).data;
}

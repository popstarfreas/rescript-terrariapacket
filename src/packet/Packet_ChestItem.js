...
function toBuffer(self) {
  return ManagedPacketWriter$PacketFactory.setType(new Packetwriter(), PacketType$TerrariaPacket.toInt(/* ChestItem */28)).packInt16(self.chestId).packByte(self.slot).packInt16(self.stack).packByte(self.prefix).packInt16(self.itemNetId).data;
}

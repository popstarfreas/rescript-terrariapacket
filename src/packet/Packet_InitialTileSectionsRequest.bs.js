...
function toBuffer(self) {
  return ManagedPacketWriter$PacketFactory.setType(new Packetwriter(), PacketType$TerrariaPacket.toInt(/* InitialTileSectionsRequest */7)).packInt32(self.x).packInt32(self.y).data;
}

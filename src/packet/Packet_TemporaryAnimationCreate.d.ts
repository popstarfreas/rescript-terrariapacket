...
/* TypeScript file generated from Packet_TemporaryAnimationCreate.res by genType. */

/* eslint-disable */
/* tslint:disable */

export type t = { readonly typeId: number; readonly tileType: number; readonly x: number; readonly y: number };

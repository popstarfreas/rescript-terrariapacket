...
function toBuffer(self) {
  return ManagedPacketWriter$PacketFactory.setType(new Packetwriter(), PacketType$TerrariaPacket.toInt(/* TileSectionFrame */10)).packInt16(self.startX).packInt16(self.startY).packInt16(self.endX).packInt16(self.endY).data;
}

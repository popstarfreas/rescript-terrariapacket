...
function toBuffer(self) {
  return ManagedPacketWriter$negPacketFactory.setType(new Packetwriter(), PacketType$negTerrariaPacket.toInt(/* PlayerHealth */14)).packByte(self.playerId).packInt16(self.health).packInt16(self.maxHealth).data;
}

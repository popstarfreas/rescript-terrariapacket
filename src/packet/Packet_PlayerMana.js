...
function toBuffer(self) {
  return ManagedPacketWriter$negPacketFactory.setType(new Packetwriter(), PacketType$negTerrariaPacket.toInt(/* PlayerMana */38)).packByte(self.playerId).packInt16(self.mana).packInt16(self.maxMana).data;
}

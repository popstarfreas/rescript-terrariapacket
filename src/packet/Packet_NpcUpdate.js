...
function readNpcFlags1(reader) {
  ...
  return {
          directionX: BitFlags$negTerrariaPacket.flag1(flags),
          directionY: BitFlags$negTerrariaPacket.flag2(flags),
          ai0: BitFlags$negTerrariaPacket.flag3(flags),
          ai1: BitFlags$negTerrariaPacket.flag4(flags),
          ai2: BitFlags$negTerrariaPacket.flag5(flags),
          ai3: BitFlags$negTerrariaPacket.flag6(flags),
          spriteDirection: BitFlags$negTerrariaPacket.flag7(flags),
          lifeMax: BitFlags$negTerrariaPacket.flag8(flags)
        };
}
...
function readNpcFlags2(reader) {
  var flags = BitFlags$negTerrariaPacket.fromByte(reader.readByte());
  return {
          statsScaled: BitFlags$negTerrariaPacket.flag1(flags),
          spawnedFromStatue: BitFlags$negTerrariaPacket.flag2(flags),
          strengthMultiplier: BitFlags$negTerrariaPacket.flag3(flags)
        };
}
...
function toBuffer(self) {
  return packReleaseOwner(packLife(packStrengthMultiplier(packPlayerCountScale(packAi(ManagedPacketWriter$negPacketFactory.setType(new Packetwriter(), PacketType$negTerrariaPacket.toInt(/* NpcUpdate */21)).packInt16(self.npcSlotId).packSingle(self.x).packSingle(self.y).packSingle(self.vx).packSingle(self.vy).packUInt16(self.target).packByte(npcFlags1(self)).packByte(npcFlags2(self)), self.ai).packInt16(self.npcTypeId), self.playerCountScale), self.strengthMultiplier), self.life), self.releaseOwner).data;
}

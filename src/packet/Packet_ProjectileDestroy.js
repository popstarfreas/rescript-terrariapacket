...
function toBuffer(self) {
  return ManagedPacketWriter$negPacketFactory.setType(new Packetwriter(), PacketType$negTerrariaPacket.toInt(/* ProjectileDestroy */25)).packInt16(self.projectileId).packByte(self.owner).data;
}

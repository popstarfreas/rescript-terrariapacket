...
function toBuffer(self) {
  return ManagedPacketWriter$PacketFactory.setType(new Packetwriter(), PacketType$TerrariaPacket.toInt(/* ProjectileDestroy */25)).packInt16(self.projectileId).packByte(self.owner).data;
}

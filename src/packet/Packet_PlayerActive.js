...
function toBuffer(self) {
  return ManagedPacketWriter$PacketFactory.setType(new Packetwriter(), PacketType$TerrariaPacket.toInt(/* PlayerActive */13)).packByte(self.playerId).packByte(self.active ? 1 : 0).data;
}

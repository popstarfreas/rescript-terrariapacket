...
import BufferreaderJs from "@popstarfreas/packetfactory/bufferreader.js";
...
function parse(payload) {
  let packetReader = new PacketreaderJs(payload);
  ...
  let reader = new BufferreaderJs(inflated._0);

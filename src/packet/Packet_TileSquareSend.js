...
function toBuffer(self) {
  return packTiles(ManagedPacketWriter$PacketFactory.setType(new Packetwriter(), PacketType$TerrariaPacket.toInt(/* TileSquareSend */18)).packInt16(self.tileX).packInt16(self.tileY).packByte(self.width).packByte(self.height).packByte(self.changeType), self.tiles).data;
}

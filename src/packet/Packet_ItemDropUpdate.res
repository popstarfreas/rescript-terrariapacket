...
module Encode = {
  ...
  let toBufferWithType = (self: t, packetType: PacketType.t) => {
    ...
    let writer =
      ...
      ->setType(packetType->PacketType.toInt)
...
let toBuffer = self => Encode.toBufferWithType(self, PacketType.ItemDropUpdate)

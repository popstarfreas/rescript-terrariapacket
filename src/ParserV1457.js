...
function getParsers(packetType, fromServer) {
  let packetName = PacketTypeV1457$TerrariaPacket.packetName(packetType);
  switch (packetType) {
    case "ConnectRequest" :
      if (fromServer) {
        return {
    ...
    case "PlayerInfo" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerInfo$TerrariaPacket.parse, a => ({
          TAG: "PlayerInfo",
          _0: a
        }), a => ({
          TAG: "PlayerInfo",
    ...
    case "PlayerInventorySlot" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerInventorySlot$TerrariaPacket.parse, a => ({
    ...
    case "WorldInfo" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1457_WorldInfo$TerrariaPacket.parse, a => ({
            TAG: "WorldInfo",
            _0: a
          }), a => ({
            TAG: "WorldInfo",
    ...
    case "InitialTileSectionsRequest" :
      if (fromServer) {
        ...
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1456_InitialTileSectionsRequest$TerrariaPacket.parse, a => ({
    ...
    case "TileSectionSend" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1456_TileSectionSend$TerrariaPacket.parse, a => ({
            TAG: "TileSectionSend",
            _0: a
          }), a => ({
            TAG: "TileSectionSend",
    ...
    case "PlayerSpawn" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerSpawn$TerrariaPacket.parse, a => ({
          TAG: "PlayerSpawn",
          _0: a
        }), a => ({
          TAG: "PlayerSpawn",
    ...
    case "PlayerUpdate" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1457_PlayerUpdate$TerrariaPacket.parse, a => ({
          TAG: "PlayerUpdate",
          _0: a
        }), a => ({
          TAG: "PlayerUpdate",
    ...
    case "TileSquareSend" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_TileSquareSend$TerrariaPacket.parse, a => ({
          TAG: "TileSquareSend",
          _0: a
        }), a => ({
          TAG: "TileSquareSend",
    ...
    case "ItemDropUpdate" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1457_ItemDropUpdate$TerrariaPacket.parse, a => ({
          TAG: "ItemDropUpdate",
          _0: a
        }), a => ({
          TAG: "ItemDropUpdate",
    ...
    case "ItemOwner" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1457_ItemOwner$TerrariaPacket.parse, a => ({
          TAG: "ItemOwner",
          _0: a
        }), a => ({
          TAG: "ItemOwner",
    ...
    case "NpcUpdate" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1457_NpcUpdate$TerrariaPacket.parse, a => ({
            TAG: "NpcUpdate",
            _0: a
          }), a => ({
            TAG: "NpcUpdate",
    ...
    case "ProjectileSync" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1457_ProjectileSync$TerrariaPacket.parse, a => ({
          TAG: "ProjectileSync",
          _0: a
        }), a => ({
          TAG: "ProjectileSync",
    ...
    case "NpcStrike" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1457_NpcStrike$TerrariaPacket.parse, a => ({
          TAG: "NpcStrike",
          _0: a
        }), a => ({
          TAG: "NpcStrike",
    ...
    case "ProjectileDestroy" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1457_ProjectileDestroy$TerrariaPacket.parse, a => ({
    ...
    case "Zones" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_Zones$TerrariaPacket.parse, a => ({
          TAG: "Zones",
          _0: a
        }), a => ({
          TAG: "Zones",
    ...
    case "ItemOwnerRemove" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1457_ItemOwnerRemove$TerrariaPacket.parse, a => ({
          TAG: "ItemOwnerRemove",
          _0: a
        }), a => ({
          TAG: "ItemOwnerRemove",
    ...
    case "PlayerBuffsSet" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerBuffsSet$TerrariaPacket.parse, a => ({
          TAG: "PlayerBuffsSet",
          _0: a
        }), a => ({
          TAG: "PlayerBuffsSet",
    ...
    case "NpcBuffUpdate" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1456_NpcBuffUpdate$TerrariaPacket.parse, a => ({
            TAG: "NpcBuffUpdate",
            _0: a
          }), a => ({
            TAG: "NpcBuffUpdate",
    ...
    case "PlayerDodge" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1457_PlayerDodge$TerrariaPacket.parse, a => ({
          TAG: "PlayerDodge",
          _0: a
        }), a => ({
          TAG: "PlayerDodge",
    ...
    case "Teleport" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_Teleport$TerrariaPacket.parse, a => ({
          TAG: "Teleport",
          _0: a
        }), a => ({
          TAG: "Teleport",
    ...
    case "NpcCatch" :
      if (fromServer) {
        ...
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1457_NpcCatch$TerrariaPacket.parse, a => ({
            TAG: "NpcCatch",
            _0: a
          }), a => ({
            TAG: "NpcCatch",
    ...
    case "TravellingMerchantInventory" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1456_TravellingMerchantInventory$TerrariaPacket.parse, a => ({
    ...
    case "TeleportationPotion" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_TeleportationPotion$TerrariaPacket.parse, a => ({
    ...
    case "NetModuleLoad" :
      return {
        TAG: "Ok",
        _0: makeParsersWithFromServer(packetName, PacketV1457_NetModuleLoad$TerrariaPacket.parse, a => ({
          TAG: "NetModuleLoad",
          _0: a
        }), a => ({
          TAG: "NetModuleLoad",
    ...
    case "ItemForceIntoNearestChest" :
      return {
        TAG: "Ok",
        _0: makeParsersWithFromServer(packetName, PacketV1456_ItemForceIntoNearestChest$TerrariaPacket.parse, a => ({
    ...
    case "ItemDropInstancedUpdate" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1457_ItemDropInstancedUpdate$TerrariaPacket.parse, a => ({
    ...
    case "Unused" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_DebugCommand$TerrariaPacket.parse, a => ({
          TAG: "Unused",
          _0: a
        }), a => ({
          TAG: "Unused",
    ...
    case "TileEntityDisplayDollItemSync" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_TileEntityDisplayDollItemSync$TerrariaPacket.parse, a => ({
    ...
    case "PlayerLuckFactorsUpdate" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerLuckFactorsUpdate$TerrariaPacket.parse, a => ({
    ...
    case "ShimmerEffectOrCoinLuck" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1456_ShimmerEffectOrCoinLuck$TerrariaPacket.parse, a => ({
    ...
    case "DeadCellsDisplayJarTryPlacing" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_DeadCellsDisplayJarTryPlacing$TerrariaPacket.parse, a => ({
    ...
    case "PlayerSpectate" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerSpectate$TerrariaPacket.parse, a => ({
          TAG: "PlayerSpectate",
          _0: a
        }), a => ({
          TAG: "PlayerSpectate",
    ...
    case "ItemDropClear" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_ItemDropClear$TerrariaPacket.parse, a => ({
          TAG: "ItemDropClear",
          _0: a
        }), a => ({
          TAG: "ItemDropClear",
    ...
    case "PlayerItemUseSound" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerItemUseSound$TerrariaPacket.parse, a => ({
    ...
    case "NpcHurtByDebuff" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_NpcHurtByDebuff$TerrariaPacket.parse, a => ({
          TAG: "NpcHurtByDebuff",
          _0: a
        }), a => ({
          TAG: "NpcHurtByDebuff",
    ...
    case "Ping" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_Ping$TerrariaPacket.parse, a => ({
          TAG: "Ping",
          _0: a
        }), a => ({
          TAG: "Ping",
    ...
    case "ChestResize" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_ChestResize$TerrariaPacket.parse, a => ({
          TAG: "ChestResize",
          _0: a
        }), a => ({
          TAG: "ChestResize",
    ...
    case "LeashedEntityAnchorInsertItem" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_LeashedEntityAnchorInsertItem$TerrariaPacket.parse, a => ({
    ...
    case "PlayerTeamUpdate" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerTeamUpdate$TerrariaPacket.parse, a => ({
    ...
    case "PlayerTeamSwapSpawn" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerTeamSwapSpawn$TerrariaPacket.parse, a => ({
    ...
    case "SectionRequest" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_SectionRequest$TerrariaPacket.parse, a => ({
          TAG: "SectionRequest",
          _0: a
        }), a => ({
          TAG: "SectionRequest",
    ...
    case "ItemDropPosition" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_ItemDropPosition$TerrariaPacket.parse, a => ({
    ...
    case "HostToken" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_HostToken$TerrariaPacket.parse, a => ({
          TAG: "HostToken",
          _0: a
        }), a => ({
          TAG: "HostToken",
    ...
    case "DamageNPCAck" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1457_DamageNPCAck$TerrariaPacket.parse, a => ({
            TAG: "DamageNPCAck",
            _0: a
          }), a => ({
            TAG: "DamageNPCAck",
    ...
    case "ServerInfo" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1457_ServerInfo$TerrariaPacket.parse, a => ({
            TAG: "ServerInfo",
            _0: a
          }), a => ({
            TAG: "ServerInfo",
    ...
    case "PlayerPlatformInfo" :
      if (fromServer) {
        ...
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1457_PlayerPlatformInfo$TerrariaPacket.parse, a => ({
...
function parse(buffer, fromServer, ignoreOpt) {
  ...
  let packetType = PacketTypeV1457$TerrariaPacket.fromInt(buffer[2]);
...
/* PacketV1456_Ping-TerrariaPacket Not a pure module */

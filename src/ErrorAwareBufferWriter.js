...
import * as BufferWriter$PacketFactory from "@popstarfreas/packetfactory/src/BufferWriter.js";
...
function make(buffer) {
  return {
    TAG: "Writing",
    _0: BufferWriter$PacketFactory.make(buffer)
  };
}
...
/* BufferWriter-PacketFactory Not a pure module */

...
function getParsers(packetType, fromServer) {
  let packetName = PacketTypeV1456$TerrariaPacket.packetName(packetType);
  switch (packetType) {
    case "ConnectRequest" :
      if (fromServer) {
        return {
    ...
    case "WorldInfo" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1456_WorldInfo$TerrariaPacket.parse, a => ({
            TAG: "WorldInfo",
            _0: a
          }), a => ({
            TAG: "WorldInfo",
    ...
    case "PlayerUpdate" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_PlayerUpdate$TerrariaPacket.parse, a => ({
          TAG: "PlayerUpdate",
          _0: a
        }), a => ({
          TAG: "PlayerUpdate",
    ...
    case "ItemOwner" :
      return {
        TAG: "Ok",
        _0: makeParsers(packetName, PacketV1456_ItemOwner$TerrariaPacket.parse, a => ({
          TAG: "ItemOwner",
          _0: a
        }), a => ({
          TAG: "ItemOwner",
    ...
    case "NpcUpdate" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1456_NpcUpdate$TerrariaPacket.parse, a => ({
            TAG: "NpcUpdate",
            _0: a
          }), a => ({
            TAG: "NpcUpdate",
    ...
    case "NetModuleLoad" :
      return {
        TAG: "Ok",
        _0: makeParsersWithFromServer(packetName, PacketV1456_NetModuleLoad$TerrariaPacket.parse, a => ({
          TAG: "NetModuleLoad",
          _0: a
        }), a => ({
          TAG: "NetModuleLoad",
    ...
    case "ServerInfo" :
      if (fromServer) {
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1456_ServerInfo$TerrariaPacket.parse, a => ({
            TAG: "ServerInfo",
            _0: a
          }), a => ({
            TAG: "ServerInfo",
    ...
    case "PlayerPlatformInfo" :
      if (fromServer) {
        ...
        return {
          TAG: "Ok",
          _0: makeParsers(packetName, PacketV1456_PlayerPlatformInfo$TerrariaPacket.parse, a => ({
...
function parse(buffer, fromServer, ignoreOpt) {
  ...
  let packetType = PacketTypeV1456$TerrariaPacket.fromInt(buffer[2]);

...
import * as PacketV1457_NpcCatch$TerrariaPacket from "./packetv1457/PacketV1457_NpcCatch.js";
...
import * as PacketV1457_ItemOwner$TerrariaPacket from "./packetv1457/PacketV1457_ItemOwner.js";
import * as PacketV1457_NpcStrike$TerrariaPacket from "./packetv1457/PacketV1457_NpcStrike.js";
import * as PacketV1457_NpcUpdate$TerrariaPacket from "./packetv1457/PacketV1457_NpcUpdate.js";
import * as PacketV1457_WorldInfo$TerrariaPacket from "./packetv1457/PacketV1457_WorldInfo.js";
...
import * as PacketV1457_ServerInfo$TerrariaPacket from "./packetv1457/PacketV1457_ServerInfo.js";
...
import * as PacketV1457_PlayerDodge$TerrariaPacket from "./packetv1457/PacketV1457_PlayerDodge.js";
...
import * as PacketV1457_DamageNPCAck$TerrariaPacket from "./packetv1457/PacketV1457_DamageNPCAck.js";
import * as PacketV1457_PlayerUpdate$TerrariaPacket from "./packetv1457/PacketV1457_PlayerUpdate.js";
...
import * as PacketV1457_NetModuleLoad$TerrariaPacket from "./packetv1457/PacketV1457_NetModuleLoad.js";
...
import * as PacketV1457_ItemDropUpdate$TerrariaPacket from "./packetv1457/PacketV1457_ItemDropUpdate.js";
import * as PacketV1457_ProjectileSync$TerrariaPacket from "./packetv1457/PacketV1457_ProjectileSync.js";
...
import * as PacketV1457_ItemOwnerRemove$TerrariaPacket from "./packetv1457/PacketV1457_ItemOwnerRemove.js";
...
import * as PacketV1457_ProjectileDestroy$TerrariaPacket from "./packetv1457/PacketV1457_ProjectileDestroy.js";
...
import * as PacketV1457_PlayerPlatformInfo$TerrariaPacket from "./packetv1457/PacketV1457_PlayerPlatformInfo.js";
...
import * as PacketV1457_ItemDropInstancedUpdate$TerrariaPacket from "./packetv1457/PacketV1457_ItemDropInstancedUpdate.js";
...
function toPacketName(packet) {
  return PacketTypeV1457$TerrariaPacket.packetName(packetTypeOf$1(packet));
}
...
function toBuffer(packet, fromServer) {
  ...
  switch (packet.TAG) {
    ...
    case "WorldInfo" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_WorldInfo$TerrariaPacket.toBuffer(packet._0));
    case "InitialTileSectionsRequest" :
    ...
    case "PlayerUpdate" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_PlayerUpdate$TerrariaPacket.toBuffer(packet._0));
    case "PlayerActive" :
    ...
    case "ItemDropUpdate" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_ItemDropUpdate$TerrariaPacket.toBuffer(packet._0));
    case "ItemOwner" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_ItemOwner$TerrariaPacket.toBuffer(packet._0));
    case "NpcUpdate" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_NpcUpdate$TerrariaPacket.toBuffer(packet._0));
    case "NpcItemStrike" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1449_NpcItemStrike$TerrariaPacket.toBuffer(packet._0));
    case "ProjectileSync" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_ProjectileSync$TerrariaPacket.toBuffer(packet._0));
    case "NpcStrike" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_NpcStrike$TerrariaPacket.toBuffer(packet._0));
    case "ProjectileDestroy" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_ProjectileDestroy$TerrariaPacket.toBuffer(packet._0));
    case "PvpToggle" :
    ...
    case "ItemOwnerRemove" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_ItemOwnerRemove$TerrariaPacket.toBuffer(packet._0));
    case "NpcTalk" :
    ...
    case "PlayerDodge" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_PlayerDodge$TerrariaPacket.toBuffer(packet._0));
    case "TilePaint" :
    ...
    case "NpcCatch" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_NpcCatch$TerrariaPacket.toBuffer(packet._0));
    case "NpcRelease" :
    ...
    case "NetModuleLoad" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_NetModuleLoad$TerrariaPacket.toBuffer(packet._0));
    case "NpcKillCount" :
    ...
    case "ItemDropInstancedUpdate" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_ItemDropInstancedUpdate$TerrariaPacket.toBuffer(packet._0));
    case "EmoteBubble" :
    ...
    case "DamageNPCAck" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_DamageNPCAck$TerrariaPacket.toBuffer(packet._0));
    case "ServerInfo" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_ServerInfo$TerrariaPacket.toBuffer(packet._0));
    case "PlayerPlatformInfo" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1457_PlayerPlatformInfo$TerrariaPacket.toBuffer(packet._0));
  }
}

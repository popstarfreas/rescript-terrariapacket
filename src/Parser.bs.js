  ...
  switch (packetType) {
    case /* ConnectRequest */0 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_ConnectRequest$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* Disconnect */1 :
        if (fromServer) {
          return Belt_Option.map(Packet_Disconnect$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* Disconnect */1,
                                _0: a
                              };
    ...
    case /* PlayerSlotSet */2 :
        if (fromServer) {
          return Belt_Option.map(Packet_PlayerSlotSet$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* PlayerSlotSet */2,
                                _0: a
                              };
    ...
    case /* PlayerInfo */3 :
        return Belt_Option.map(Packet_PlayerInfo$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* PlayerInfo */3,
                              _0: a
                            };
    ...
    case /* PlayerInventorySlot */4 :
        return Belt_Option.map(Packet_PlayerInventorySlot$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* WorldDataRequest */5 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_WorldDataRequest$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* WorldInfo */6 :
        if (fromServer) {
          return Belt_Option.map(Packet_WorldInfo$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* WorldInfo */6,
                                _0: a
                              };
    ...
    case /* InitialTileSectionsRequest */7 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_InitialTileSectionsRequest$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* Status */8 :
        if (fromServer) {
          return Belt_Option.map(Packet_Status$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* Status */8,
                                _0: a
                              };
    ...
    case /* TileSectionSend */9 :
        if (fromServer) {
          return Belt_Option.map(Packet_TileSectionSend$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* TileSectionFrame */10 :
        if (fromServer) {
          return Belt_Option.map(Packet_TileSectionFrame$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* PlayerSpawn */11 :
        return Belt_Option.map(Packet_PlayerSpawn$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* PlayerSpawn */11,
                              _0: a
                            };
    ...
    case /* PlayerUpdate */12 :
        return Belt_Option.map(Packet_PlayerUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* PlayerUpdate */12,
                              _0: a
                            };
    ...
    case /* PlayerActive */13 :
        if (fromServer) {
          return Belt_Option.map(Packet_PlayerActive$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* PlayerActive */13,
                                _0: a
                              };
    ...
    case /* PlayerHealth */14 :
        return Belt_Option.map(Packet_PlayerHealth$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* PlayerHealth */14,
                              _0: a
                            };
    ...
    case /* TileModify */15 :
        return Belt_Option.map(Packet_TileModify$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* TileModify */15,
                              _0: a
                            };
    ...
    case /* TimeSet */16 :
        if (fromServer) {
          return Belt_Option.map(Packet_TimeSet$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* TimeSet */16,
                                _0: a
                              };
    ...
    case /* DoorUse */17 :
        return Belt_Option.map(Packet_DoorUse$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* DoorUse */17,
                              _0: a
                            };
    ...
    case /* TileSquareSend */18 :
        return Belt_Option.map(Packet_TileSquareSend$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* ItemDropUpdate */19 :
        return Belt_Option.map(Packet_ItemDropUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* ItemOwner */20 :
        return Belt_Option.map(Packet_ItemOwner$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* ItemOwner */20,
                              _0: a
                            };
    ...
    case /* NpcUpdate */21 :
        if (fromServer) {
          return Belt_Option.map(Packet_NpcUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* NpcUpdate */21,
                                _0: a
                              };
    ...
    case /* NpcItemStrike */22 :
        return Belt_Option.map(Packet_NpcItemStrike$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* ProjectileSync */23 :
        return Belt_Option.map(Packet_ProjectileSync$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* NpcStrike */24 :
        return Belt_Option.map(Packet_NpcStrike$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* NpcStrike */24,
                              _0: a
                            };
    ...
    case /* ProjectileDestroy */25 :
        return Belt_Option.map(Packet_ProjectileDestroy$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* PvpToggle */26 :
        return Belt_Option.map(Packet_PvpToggle$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* PvpToggle */26,
                              _0: a
                            };
    ...
    case /* ChestOpen */27 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_ChestOpen$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* ChestOpen */27,
                                _0: a
                              };
    ...
    case /* ChestItem */28 :
        return Belt_Option.map(Packet_ChestItem$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* ChestItem */28,
                              _0: a
                            };
    ...
    case /* ActiveContainerSync */29 :
        return Belt_Option.map(Packet_ActiveContainerSync$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* ChestPlace */30 :
        return Belt_Option.map(Packet_ChestPlace$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* ChestPlace */30,
                              _0: a
                            };
    ...
    case /* HealEffect */31 :
        return Belt_Option.map(Packet_HealEffect$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* HealEffect */31,
                              _0: a
                            };
    ...
    case /* Zones */32 :
        return Belt_Option.map(Packet_Zones$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* Zones */32,
                              _0: a
                            };
    ...
    case /* PasswordRequired */33 :
        if (fromServer) {
          return Belt_Option.map(Packet_PasswordRequired$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* PasswordSend */34 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_PasswordSend$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* PasswordSend */34,
                                _0: a
                              };
    ...
    case /* ItemOwnerRemove */35 :
        if (fromServer) {
          return Belt_Option.map(Packet_ItemOwnerRemove$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* NpcTalk */36 :
        return Belt_Option.map(Packet_NpcTalk$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* NpcTalk */36,
                              _0: a
                            };
    ...
    case /* PlayerAnimation */37 :
        return Belt_Option.map(Packet_PlayerAnimation$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* PlayerMana */38 :
        return Belt_Option.map(Packet_PlayerMana$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* PlayerMana */38,
                              _0: a
                            };
    ...
    case /* ManaEffect */39 :
        return Belt_Option.map(Packet_ManaEffect$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* ManaEffect */39,
                              _0: a
                            };
    ...
    case /* PlayerTeam */40 :
        return Belt_Option.map(Packet_PlayerTeam$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* PlayerTeam */40,
                              _0: a
                            };
    ...
    case /* SignRead */41 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_SignRead$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* SignRead */41,
                                _0: a
                              };
    ...
    case /* SignNew */42 :
        return Belt_Option.map(Packet_SignNew$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* SignNew */42,
                              _0: a
                            };
    ...
    case /* LiquidSet */43 :
        return Belt_Option.map(Packet_LiquidSet$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* LiquidSet */43,
                              _0: a
                            };
    ...
    case /* PlayerSpawnSelf */44 :
        if (fromServer) {
          return Belt_Option.map(Packet_PlayerSpawnSelf$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* PlayerBuffsSet */45 :
        return Belt_Option.map(Packet_PlayerBuffsSet$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* NpcSpecialEffect */46 :
        return Belt_Option.map(Packet_NpcSpecialEffect$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* ChestOrTempleUnlock */47 :
        return Belt_Option.map(Packet_ChestOrTempleUnlock$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* NpcBuffAdd */48 :
        return Belt_Option.map(Packet_NpcBuffAdd$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* NpcBuffAdd */48,
                              _0: a
                            };
    ...
    case /* NpcBuffUpdate */49 :
        if (fromServer) {
          return Belt_Option.map(Packet_NpcBuffUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* PlayerBuffAdd */50 :
        return Belt_Option.map(Packet_PlayerBuffAdd$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* NpcNameUpdate */51 :
        return Belt_Option.map(Packet_NpcNameUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* GoodEvilUpdate */52 :
        if (fromServer) {
          return Belt_Option.map(Packet_GoodEvilUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* HarpPlay */53 :
        return Belt_Option.map(Packet_HarpPlay$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* HarpPlay */53,
                              _0: a
                            };
    ...
    case /* SwitchHit */54 :
        return Belt_Option.map(Packet_SwitchHit$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* SwitchHit */54,
                              _0: a
                            };
    ...
    case /* NpcHomeUpdate */55 :
        return Belt_Option.map(Packet_NpcHomeUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* BossOrInvasionSpawn */56 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_BossOrInvasionSpawn$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* PlayerDodge */57 :
        return Belt_Option.map(Packet_PlayerDodge$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* PlayerDodge */57,
                              _0: a
                            };
    ...
    case /* Teleport */60 :
        return Belt_Option.map(Packet_Teleport$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* Teleport */60,
                              _0: a
                            };
    ...
    case /* PlayerHealOther */61 :
        return Belt_Option.map(Packet_PlayerHealOther$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* DimensionsUpdate */62 :
        return Belt_Option.map(Packet_DimensionsUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* ClientUuid */63 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_ClientUuid$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* ClientUuid */63,
                                _0: a
                              };
    ...
    case /* ChestName */64 :
        return Belt_Option.map(Packet_ChestName$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* ChestName */64,
                              _0: a
                            };
    ...
    case /* CatchNpc */65 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_CatchNpc$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* CatchNpc */65,
                                _0: a
                              };
    ...
    case /* ReleaseNpc */66 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_ReleaseNpc$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* ReleaseNpc */66,
                                _0: a
                              };
    ...
    case /* TravellingMerchantInventory */67 :
        if (fromServer) {
          return Belt_Option.map(Packet_TravellingMerchantInventory$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* TeleportationPotion */68 :
        return Belt_Option.map(Packet_TeleportationPotion$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* AnglerQuest */69 :
        if (fromServer) {
          return Belt_Option.map(Packet_AnglerQuest$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* AnglerQuest */69,
                                _0: a
                              };
    ...
    case /* AnglerQuestComplete */70 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_AnglerQuestComplete$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* AnglerQuestsCompletedAmount */71 :
        return Belt_Option.map(Packet_AnglerQuestsCompletedAmount$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* TemporaryAnimationCreate */72 :
        if (fromServer) {
          return Belt_Option.map(Packet_TemporaryAnimationCreate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* InvasionProgressReport */73 :
        if (fromServer) {
          return Belt_Option.map(Packet_InvasionProgressReport$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* ObjectPlace */74 :
        return Belt_Option.map(Packet_ObjectPlace$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* ObjectPlace */74,
                              _0: a
                            };
    ...
    case /* PlayerChestIndexSync */75 :
        if (fromServer) {
          return Belt_Option.map(Packet_PlayerChestIndexSync$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* CombatNumberCreate */76 :
        if (fromServer) {
          return Belt_Option.map(Packet_CombatNumberCreate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* NetModuleLoad */77 :
        return Belt_Option.map(Packet_NetModuleLoad$DarkgamingRescriptTerrariapacket.parse(payload, fromServer), (function (a) {
                      return {
    ...
    case /* NpcKillCount */78 :
        if (fromServer) {
          return Belt_Option.map(Packet_NpcKillCount$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* NpcKillCount */78,
                                _0: a
                              };
    ...
    case /* PlayerStealth */79 :
        return Belt_Option.map(Packet_PlayerStealth$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* ItemForceIntoNearestChest */80 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_ItemForceIntoNearestChest$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* TileEntityUpdate */81 :
        if (fromServer) {
          return Belt_Option.map(Packet_TileEntityUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* TileEntityPlace */82 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_TileEntityPlace$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* ItemDropModify */83 :
        if (fromServer) {
          return Belt_Option.map(Packet_ItemDropModify$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* ItemFramePlace */84 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_ItemFramePlace$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* ItemDropInstancedUpdate */85 :
        return Belt_Option.map(Packet_ItemDropInstancedUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* EmoteBubble */86 :
        if (fromServer) {
          return Belt_Option.map(Packet_EmoteBubble$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* EmoteBubble */86,
                                _0: a
                              };
    ...
    case /* ExtraValueSync */87 :
        return Belt_Option.map(Packet_ExtraValueSync$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* SocialHandshake */88 :
        return Belt_Option.map(Packet_SocialHandshake$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* Unused */89 :
        return Belt_Option.map(Packet_Unused$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* Unused */89,
                              _0: a
                            };
    ...
    case /* PortalKill */90 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_PortalKill$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* PortalKill */90,
                                _0: a
                              };
    ...
    case /* PlayerTeleportPortal */91 :
        return Belt_Option.map(Packet_PlayerTeleportPortal$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* NpcKilledNotification */92 :
        if (fromServer) {
          return Belt_Option.map(Packet_NpcKilledNotification$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* EventNotification */93 :
        if (fromServer) {
          return Belt_Option.map(Packet_EventNotification$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* MinionTargetUpdate */94 :
        return Belt_Option.map(Packet_MinionTargetUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* NpcTeleportPortal */95 :
        return Belt_Option.map(Packet_NpcTeleportPortal$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* ShieldStrengthsUpdate */96 :
        if (fromServer) {
          return Belt_Option.map(Packet_ShieldStrengthsUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* NebulaLevelUp */97 :
        return Belt_Option.map(Packet_NebulaLevelUp$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* MoonLordCountdown */98 :
        if (fromServer) {
          return Belt_Option.map(Packet_MoonLordCountdown$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* NpcShopItem */99 :
        if (fromServer) {
          return Belt_Option.map(Packet_NpcShopItem$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* NpcShopItem */99,
                                _0: a
                              };
    ...
    case /* GemLockToggle */100 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_GemLockToggle$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* SmokePoof */101 :
        if (fromServer) {
          return Belt_Option.map(Packet_SmokePoof$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* SmokePoof */101,
                                _0: a
                              };
    ...
    case /* ChatMessageSmart */102 :
        if (fromServer) {
          return Belt_Option.map(Packet_ChatMessageSmart$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* WiredCannonShot */103 :
        if (fromServer) {
          return Belt_Option.map(Packet_WiredCannonShot$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* MassWireOperation */104 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_MassWireOperation$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* MassWireOperationPay */105 :
        if (fromServer) {
          return Belt_Option.map(Packet_MassWireOperationPay$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* PartyToggle */106 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_PartyToggle$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* PartyToggle */106,
                                _0: a
                              };
    ...
    case /* TreeGrowFx */107 :
        return Belt_Option.map(Packet_TreeGrowFx$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* TreeGrowFx */107,
                              _0: a
                            };
    ...
    case /* CrystalInvasionStart */108 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_CrystalInvasionStart$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* CrystalInvasionWipeAll */109 :
        if (fromServer) {
          return Belt_Option.map(Packet_CrystalInvasionWipeAll$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* MinionAttackTargetUpdate */110 :
        return Belt_Option.map(Packet_MinionAttackTargetUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* CrystalInvasionSendWaitTime */111 :
        if (fromServer) {
          return Belt_Option.map(Packet_CrystalInvasionSendWaitTime$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* PlayerDamage */112 :
        return Belt_Option.map(Packet_PlayerDamage$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* PlayerDeath */113 :
        return Belt_Option.map(Packet_PlayerDeath$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
                              TAG: /* PlayerDeath */113,
                              _0: a
                            };
    ...
    case /* CombatTextCreate */114 :
        if (fromServer) {
          return Belt_Option.map(Packet_CombatTextCreate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* Emoji */115 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_Emoji$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* Emoji */115,
                                _0: a
                              };
    ...
    case /* TileEntityDisplayDollItemSync */116 :
        return Belt_Option.map(Packet_TileEntityDisplayDollItemSync$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* TileEntityInteractionRequest */117 :
        return Belt_Option.map(Packet_TileEntityInteractionRequest$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* WeaponsRackTryPlacing */118 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_WeaponsRackTryPlacing$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* TileEntityHatRackItemSync */119 :
        return Belt_Option.map(Packet_TileEntityHatRackItemSync$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* TilePickingSync */120 :
        return Belt_Option.map(Packet_TilePickingSync$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* RevengeMarkerSync */121 :
        if (fromServer) {
          return Belt_Option.map(Packet_RevengeMarkerSync$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* RevengeMarkerRemove */122 :
        if (fromServer) {
          return Belt_Option.map(Packet_RevengeMarkerRemove$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* GolfBallLandInCup */123 :
        return Belt_Option.map(Packet_GolfBallLandInCup$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* ClientFinishConnectingToServer */124 :
        if (fromServer) {
          return Belt_Option.map(Packet_ClientFinishConnectingToServer$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* NpcFishOut */125 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_NpcFishOut$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* NpcFishOut */125,
                                _0: a
                              };
    ...
    case /* NpcTamper */126 :
        if (fromServer) {
          return Belt_Option.map(Packet_NpcTamper$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* NpcTamper */126,
                                _0: a
                              };
    ...
    case /* LegacySoundPlay */127 :
        if (fromServer) {
          return Belt_Option.map(Packet_LegacySoundPlay$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* FoodPlatterTryPlacing */128 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_FoodPlatterTryPlacing$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* PlayerLuckFactorsUpdate */129 :
        return Belt_Option.map(Packet_PlayerLuckFactorsUpdate$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* PlayerDead */130 :
        if (fromServer) {
          return Belt_Option.map(Packet_PlayerDead$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
                                TAG: /* PlayerDead */130,
                                _0: a
                              };
    ...
    case /* CavernMonsterTypeSync */131 :
        return Belt_Option.map(Packet_CavernMonsterTypeSync$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                      return {
    ...
    case /* NpcBuffRemovalRequest */132 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_NpcBuffRemovalRequest$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* ClientSyncedInventory */133 :
        if (fromServer) {
          ...
          return Belt_Option.map(Packet_ClientSyncedInventory$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {
    ...
    case /* CountsAsHostForGameplaySet */134 :
        if (fromServer) {
          return Belt_Option.map(Packet_CountsAsHostForGameplaySet$DarkgamingRescriptTerrariapacket.parse(payload), (function (a) {
                        return {

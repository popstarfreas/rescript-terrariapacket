...
module LazyPacket = {
  type t =
    ...
    | PlayerSlotSet(Lazy.t<option<PlayerSlotSet.t>>)
    | PlayerInfo(Lazy.t<option<PlayerInfo.t>>)
    | PlayerInventorySlot(Lazy.t<option<PlayerInventorySlot.t>>)
    | WorldDataRequest(Lazy.t<option<WorldDataRequest.t>>)
    | WorldInfo(Lazy.t<option<WorldInfo.t>>)
    | InitialTileSectionsRequest(Lazy.t<option<InitialTileSectionsRequest.t>>)
    | Status(Lazy.t<option<Status.t>>)
    | TileSectionSend(Lazy.t<option<TileSectionSend.t>>)
    | TileSectionFrame(Lazy.t<option<TileSectionFrame.t>>)
    | PlayerSpawn(Lazy.t<option<PlayerSpawn.t>>)
    | PlayerUpdate(Lazy.t<option<PlayerUpdate.t>>)
    | PlayerActive(Lazy.t<option<PlayerActive.t>>)
    | PlayerHealth(Lazy.t<option<PlayerHealth.t>>)
    | TileModify(Lazy.t<option<TileModify.t>>)
    | TimeSet(Lazy.t<option<TimeSet.t>>)
    | DoorUse(Lazy.t<option<DoorUse.t>>)
    | TileSquareSend(Lazy.t<option<TileSquareSend.t>>)
    | ItemDropUpdate(Lazy.t<option<ItemDropUpdate.t>>)
    | ItemOwner(Lazy.t<option<ItemOwner.t>>)
    | NpcUpdate(Lazy.t<option<NpcUpdate.t>>)
    | NpcItemStrike(Lazy.t<option<NpcItemStrike.t>>)
    | ProjectileSync(Lazy.t<option<ProjectileSync.t>>)
    | NpcStrike(Lazy.t<option<NpcStrike.t>>)
    | ProjectileDestroy(Lazy.t<option<ProjectileDestroy.t>>)
    | PvpToggle(Lazy.t<option<PvpToggle.t>>)
    | ChestOpen(Lazy.t<option<ChestOpen.t>>)
    | ChestItem(Lazy.t<option<ChestItem.t>>)
    | ActiveContainerSync(Lazy.t<option<ActiveContainerSync.t>>)
    | ChestPlace(Lazy.t<option<ChestPlace.t>>)
    | HealEffect(Lazy.t<option<HealEffect.t>>)
    | Zones(Lazy.t<option<Zones.t>>)
    | PasswordRequired(Lazy.t<option<PasswordRequired.t>>)
    | PasswordSend(Lazy.t<option<PasswordSend.t>>)
    | ItemOwnerRemove(Lazy.t<option<ItemOwnerRemove.t>>)
    | NpcTalk(Lazy.t<option<NpcTalk.t>>)
    | PlayerAnimation(Lazy.t<option<PlayerAnimation.t>>)
    | PlayerMana(Lazy.t<option<PlayerMana.t>>)
    | ManaEffect(Lazy.t<option<ManaEffect.t>>)
    | PlayerTeam(Lazy.t<option<PlayerTeam.t>>)
    | SignRead(Lazy.t<option<SignRead.t>>)
    | SignNew(Lazy.t<option<SignNew.t>>)
    | LiquidSet(Lazy.t<option<LiquidSet.t>>)
    ...
    | NpcNameUpdate(Lazy.t<option<NpcNameUpdate.t>>)
    | GoodEvilUpdate(Lazy.t<option<GoodEvilUpdate.t>>)
    | HarpPlay(Lazy.t<option<HarpPlay.t>>)
    | SwitchHit(Lazy.t<option<SwitchHit.t>>)
    ...
    | AnglerQuestComplete(Lazy.t<option<AnglerQuestComplete.t>>)
    | AnglerQuestsCompletedAmount(Lazy.t<option<AnglerQuestsCompletedAmount.t>>)
    | TemporaryAnimationCreate(Lazy.t<option<TemporaryAnimationCreate.t>>)
    | InvasionProgressReport(Lazy.t<option<InvasionProgressReport.t>>)
    | ObjectPlace(Lazy.t<option<ObjectPlace.t>>)
    | PlayerChestIndexSync(Lazy.t<option<PlayerChestIndexSync.t>>)
    | CombatNumberCreate(Lazy.t<option<CombatNumberCreate.t>>)
    | NetModuleLoad(Lazy.t<option<NetModuleLoad.t>>)
    | NpcKillCount(Lazy.t<option<NpcKillCount.t>>)
    | PlayerStealth(Lazy.t<option<PlayerStealth.t>>)
    | ItemForceIntoNearestChest(Lazy.t<option<ItemForceIntoNearestChest.t>>)
    | TileEntityUpdate(Lazy.t<option<TileEntityUpdate.t>>)
    | TileEntityPlace(Lazy.t<option<TileEntityPlace.t>>)
    | ItemDropModify(Lazy.t<option<ItemDropModify.t>>)
    | ItemFramePlace(Lazy.t<option<ItemFramePlace.t>>)
    | ItemDropInstancedUpdate(Lazy.t<option<ItemDropInstancedUpdate.t>>)
    | EmoteBubble(Lazy.t<option<EmoteBubble.t>>)
    | ExtraValueSync(Lazy.t<option<ExtraValueSync.t>>)
    | SocialHandshake(Lazy.t<option<SocialHandshake.t>>)
    | Unused(Lazy.t<option<Unused.t>>)
    | PortalKill(Lazy.t<option<PortalKill.t>>)
    | PlayerTeleportPortal(Lazy.t<option<PlayerTeleportPortal.t>>)
    | NpcKilledNotification(Lazy.t<option<NpcKilledNotification.t>>)
    | EventNotification(Lazy.t<option<EventNotification.t>>)
    | MinionTargetUpdate(Lazy.t<option<MinionTargetUpdate.t>>)
    | NpcTeleportPortal(Lazy.t<option<NpcTeleportPortal.t>>)
    | ShieldStrengthsUpdate(Lazy.t<option<ShieldStrengthsUpdate.t>>)
    | NebulaLevelUp(Lazy.t<option<NebulaLevelUp.t>>)
    | MoonLordCountdown(Lazy.t<option<MoonLordCountdown.t>>)
    | NpcShopItem(Lazy.t<option<NpcShopItem.t>>)
    | GemLockToggle(Lazy.t<option<GemLockToggle.t>>)
    | SmokePoof(Lazy.t<option<SmokePoof.t>>)
    | ChatMessageSmart(Lazy.t<option<ChatMessageSmart.t>>)
    | WiredCannonShot(Lazy.t<option<WiredCannonShot.t>>)
    | MassWireOperation(Lazy.t<option<MassWireOperation.t>>)
    | MassWireOperationPay(Lazy.t<option<MassWireOperationPay.t>>)
    | PartyToggle(Lazy.t<option<PartyToggle.t>>)
    | TreeGrowFx(Lazy.t<option<TreeGrowFx.t>>)
    | CrystalInvasionStart(Lazy.t<option<CrystalInvasionStart.t>>)
    | CrystalInvasionWipeAll(Lazy.t<option<CrystalInvasionWipeAll.t>>)
    | MinionAttackTargetUpdate(Lazy.t<option<MinionAttackTargetUpdate.t>>)
    | CrystalInvasionSendWaitTime(Lazy.t<option<CrystalInvasionSendWaitTime.t>>)
    | PlayerDamage(Lazy.t<option<PlayerDamage.t>>)
    | PlayerDeath(Lazy.t<option<PlayerDeath.t>>)
    | CombatTextCreate(Lazy.t<option<CombatTextCreate.t>>)
    | Emoji(Lazy.t<option<Emoji.t>>)
    | TileEntityDisplayDollItemSync(Lazy.t<option<TileEntityDisplayDollItemSync.t>>)
    | TileEntityInteractionRequest(Lazy.t<option<TileEntityInteractionRequest.t>>)
    | WeaponsRackTryPlacing(Lazy.t<option<WeaponsRackTryPlacing.t>>)
    | TileEntityHatRackItemSync(Lazy.t<option<TileEntityHatRackItemSync.t>>)
    | TilePickingSync(Lazy.t<option<TilePickingSync.t>>)
    | RevengeMarkerSync(Lazy.t<option<RevengeMarkerSync.t>>)
    | RevengeMarkerRemove(Lazy.t<option<RevengeMarkerRemove.t>>)
    | GolfBallLandInCup(Lazy.t<option<GolfBallLandInCup.t>>)
    | ClientFinishConnectingToServer(Lazy.t<option<ClientFinishConnectingToServer.t>>)
    | NpcFishOut(Lazy.t<option<NpcFishOut.t>>)
    | NpcTamper(Lazy.t<option<NpcTamper.t>>)
    | LegacySoundPlay(Lazy.t<option<LegacySoundPlay.t>>)
    | FoodPlatterTryPlacing(Lazy.t<option<FoodPlatterTryPlacing.t>>)
    | PlayerLuckFactorsUpdate(Lazy.t<option<PlayerLuckFactorsUpdate.t>>)
    | PlayerDead(Lazy.t<option<PlayerDead.t>>)
    | CavernMonsterTypeSync(Lazy.t<option<CavernMonsterTypeSync.t>>)
...
let toBuffer = (packet: t, _fromServer: bool): ISerializer.toBufferResult => {
  ...
  | TileModify(tileModify) => Ok(TileModify.toBuffer(tileModify))
  ...
  | ItemOwner(itemOwner) => Ok(ItemOwner.toBuffer(itemOwner))
  ...
  | ChestPlace(chestPlace) => Ok(ChestPlace.toBuffer(chestPlace))
  ...
  | ItemDropShimmeredUpdate(itemDropShimmeredUpdate) =>
    Ok(ItemDropShimmeredUpdate.toBuffer(itemDropShimmeredUpdate))
  ...
  | ItemDropProtectedUpdate(itemDropProtectedUpdate) =>
    Ok(ItemDropProtectedUpdate.toBuffer(itemDropProtectedUpdate))
  }
}

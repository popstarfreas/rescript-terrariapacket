    ...
    if height < 0 || width < 0 {
      ...
      | Ok(_) =>
        ...
        let? Ok() = if bytesLeft == 0 {
          ...
          Error({
            ErrorAwarePacketReader.context: "PacketV1456_TileSectionSend.entities",
...
module Encode = {
  ...
  let toBuffer = (self: t): result<NodeJs.Buffer.t, ErrorAwarePacketWriter.packError> => {
    let outerPacketWriter =
      ErrorAwarePacketWriter.make()->setType(PacketTypeV1456.TileSectionSend->PacketTypeV1456.toInt)

...
module Decode = {
  ...
  let parse = (payload: NodeJs.Buffer.t): result<t, ErrorAwarePacketReader.readError> => {
    ...
    let? Ok(townNPCs) = reader->readByte("townNPCs")
    Ok({playerId, zone1, zone2, zone3, zone4, zone5, townNPCs})
  }
}
...
module Encode = {
  ...
  let toBuffer = (self: t): result<NodeJs.Buffer.t, ErrorAwarePacketWriter.packError> =>
    ...
    ->setType(PacketTypeV1456.Zones->PacketTypeV1456.toInt)
    ...
    ->packByte(self.townNPCs, "townNPCs")
    ->data
}

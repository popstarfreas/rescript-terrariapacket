...
function packTile(writer, tile) {
  ...
  let flags2 = BitFlags$TerrariaPacket.fromFlags(tile.wire2, tile.wire3, Stdlib_Option.isSome(tile.color), Stdlib_Option.isSome(tile.wallColor), Stdlib_Option.mapOr(tile.activeTile, false, tile => (tile.slope & 1) === 1), Stdlib_Option.mapOr(tile.activeTile, false, tile => (tile.slope & 2) === 2), Stdlib_Option.mapOr(tile.activeTile, false, tile => (tile.slope & 4) === 4), tile.wire4);

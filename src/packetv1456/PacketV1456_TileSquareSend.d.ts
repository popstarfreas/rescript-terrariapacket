/* TypeScript file generated from PacketV1456_TileSquareSend.resi by genType. */
...
export declare const Decode: { parse: (_1: Buffer) => parse };

export declare const Encode: { toBuffer: (_1: t) => toBuffer };

...
import * as PacketV1456_ItemOwner$TerrariaPacket from "./packetv1456/PacketV1456_ItemOwner.js";
import * as PacketV1456_NpcUpdate$TerrariaPacket from "./packetv1456/PacketV1456_NpcUpdate.js";
import * as PacketV1456_WorldInfo$TerrariaPacket from "./packetv1456/PacketV1456_WorldInfo.js";
...
import * as PacketV1456_ServerInfo$TerrariaPacket from "./packetv1456/PacketV1456_ServerInfo.js";
...
import * as PacketV1456_PlayerUpdate$TerrariaPacket from "./packetv1456/PacketV1456_PlayerUpdate.js";
...
import * as PacketV1456_NetModuleLoad$TerrariaPacket from "./packetv1456/PacketV1456_NetModuleLoad.js";
...
import * as PacketV1456_PlayerPlatformInfo$TerrariaPacket from "./packetv1456/PacketV1456_PlayerPlatformInfo.js";
...
function toPacketName(packet) {
  return PacketTypeV1456$TerrariaPacket.packetName(packetTypeOf$1(packet));
}
...
function toBuffer(packet, fromServer) {
  ...
  switch (packet.TAG) {
    ...
    case "WorldInfo" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1456_WorldInfo$TerrariaPacket.toBuffer(packet._0));
    case "InitialTileSectionsRequest" :
    ...
    case "PlayerUpdate" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1456_PlayerUpdate$TerrariaPacket.toBuffer(packet._0));
    case "PlayerActive" :
    ...
    case "ItemOwner" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1456_ItemOwner$TerrariaPacket.toBuffer(packet._0));
    case "NpcUpdate" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1456_NpcUpdate$TerrariaPacket.toBuffer(packet._0));
    case "NpcItemStrike" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1449_NpcItemStrike$TerrariaPacket.toBuffer(packet._0));
    case "ProjectileSync" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1449_ProjectileSync$TerrariaPacket.toBuffer(packet._0));
    case "NpcStrike" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1449_NpcStrike$TerrariaPacket.toBuffer(packet._0));
    case "ProjectileDestroy" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1449_ProjectileDestroy$TerrariaPacket.toBuffer(packet._0));
    case "PvpToggle" :
    ...
    case "ItemOwnerRemove" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1449_ItemOwnerRemove$TerrariaPacket.toBuffer(packet._0));
    case "NpcTalk" :
    ...
    case "PlayerDodge" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1449_PlayerDodge$TerrariaPacket.toBuffer(packet._0));
    case "TilePaint" :
    ...
    case "NpcCatch" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1449_NpcCatch$TerrariaPacket.toBuffer(packet._0));
    case "NpcRelease" :
    ...
    case "NetModuleLoad" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1456_NetModuleLoad$TerrariaPacket.toBuffer(packet._0));
    case "NpcKillCount" :
    ...
    case "ItemDropInstancedUpdate" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1449_ItemDropInstancedUpdate$TerrariaPacket.toBuffer(packet._0));
    case "EmoteBubble" :
    ...
    case "ServerInfo" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1456_ServerInfo$TerrariaPacket.toBuffer(packet._0));
    case "PlayerPlatformInfo" :
      return ISerializer$TerrariaPacket.toBufferResult(PacketV1456_PlayerPlatformInfo$TerrariaPacket.toBuffer(packet._0));
  }
}

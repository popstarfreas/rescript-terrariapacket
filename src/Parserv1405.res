...
let parsePayloadLazy = (packetType: PacketType.t, payload: NodeJs.Buffer.t, fromServer: bool): option<Packetv1405.Lazy.t> =>
  switch (packetType, fromServer) {
  | (ConnectRequest, true) => None
  | (ConnectRequest, false) =>
    Some(Packetv1405.Lazy.ConnectRequest(lazy(Packetv1405.ConnectRequest.parse(payload))))
  | (Disconnect, false) => None
  | (Disconnect, true) => Some(Packetv1405.Lazy.Disconnect(lazy(Packetv1405.Disconnect.parse(payload))))
  | (PlayerSlotSet, false) => None
  | (PlayerSlotSet, true) =>
    Some(Packetv1405.Lazy.PlayerSlotSet(lazy(Packetv1405.PlayerSlotSet.parse(payload))))
  | (PlayerInfo, true | false) => Some(Packetv1405.Lazy.PlayerInfo(lazy(Packetv1405.PlayerInfo.parse(payload))))
  | (PlayerInventorySlot, true | false) =>
  ...
  | (InitialTileSectionsRequest, true) => None
  | (InitialTileSectionsRequest, false) =>
    Some(Packetv1405.Lazy.InitialTileSectionsRequest(lazy(Packetv1405.InitialTileSectionsRequest.parse(payload))))
  | (Status, false) => None
  ...
  | (PlayerSpawn, false) => Some(Packetv1405.Lazy.PlayerSpawn(lazy(Packetv1405.PlayerSpawn.parse(payload))))
  | (PlayerUpdate, true | false) => Some(Packetv1405.Lazy.PlayerUpdate(lazy(Packetv1405.PlayerUpdate.parse(payload))))
  | (PlayerActive, false) => None
  | (PlayerActive, true) => Some(Packetv1405.Lazy.PlayerActive(lazy(Packetv1405.PlayerActive.parse(payload))))
  | (PlayerHealth, true | false) => Some(Packetv1405.Lazy.PlayerHealth(lazy(Packetv1405.PlayerHealth.parse(payload))))
  | (TileModify, true | false) => Some(Packetv1405.Lazy.TileModify(lazy(Packetv1405.TileModify.parse(payload))))
  | (TimeSet, false) => None
  | (TimeSet, true) => Some(Packetv1405.Lazy.TimeSet(lazy(Packetv1405.TimeSet.parse(payload))))
  | (DoorUse, true | false) => Some(Packetv1405.Lazy.DoorUse(lazy(Packetv1405.DoorUse.parse(payload))))
  | (TileSquareSend, true | false) =>
  ...
  | (ItemOwner, true | false) => Some(Packetv1405.Lazy.ItemOwner(lazy(Packetv1405.ItemOwner.parse(payload))))
  | (NpcUpdate, false) => {
    None
  }
  ...
  | (NpcStrike, true | false) => Some(Packetv1405.Lazy.NpcStrike(lazy(Packetv1405.NpcStrike.parse(payload))))
  | (ProjectileDestroy, true | false) =>
    Some(Packetv1405.Lazy.ProjectileDestroy(lazy(Packetv1405.ProjectileDestroy.parse(payload))))
  | (PvpToggle, true | false) => Some(Packetv1405.Lazy.PvpToggle(lazy(Packetv1405.PvpToggle.parse(payload))))
  | (ChestOpen, true) => None
  | (ChestOpen, false) => Some(Packetv1405.Lazy.ChestOpen(lazy(Packetv1405.ChestOpen.parse(payload))))
  | (ChestItem, true | false) => Some(Packetv1405.Lazy.ChestItem(lazy(Packetv1405.ChestItem.parse(payload))))
  | (ActiveContainerSync, true | false) =>
    Some(Packetv1405.Lazy.ActiveContainerSync(lazy(Packetv1405.ActiveContainerSync.parse(payload))))
  | (ChestPlace, true | false) => Some(Packetv1405.Lazy.ChestPlace(lazy(Packetv1405.ChestPlace.parse(payload))))
  | (HealEffect, true | false) => Some(Packetv1405.Lazy.HealEffect(lazy(Packetv1405.HealEffect.parse(payload))))
  ...
  | (PasswordSend, true) => None
  | (PasswordSend, false) => Some(Packetv1405.Lazy.PasswordSend(lazy(Packetv1405.PasswordSend.parse(payload))))
  | (ItemOwnerRemove, false) => None
  | (ItemOwnerRemove, true) =>
    Some(Packetv1405.Lazy.ItemOwnerRemove(lazy(Packetv1405.ItemOwnerRemove.parse(payload))))
  | (NpcTalk, true | false) => Some(Packetv1405.Lazy.NpcTalk(lazy(Packetv1405.NpcTalk.parse(payload))))
  | (PlayerAnimation, true | false) =>
    Some(Packetv1405.Lazy.PlayerAnimation(lazy(Packetv1405.PlayerAnimation.parse(payload))))
  | (PlayerMana, true | false) => Some(Packetv1405.Lazy.PlayerMana(lazy(Packetv1405.PlayerMana.parse(payload))))
  | (ManaEffect, true | false) => Some(Packetv1405.Lazy.ManaEffect(lazy(Packetv1405.ManaEffect.parse(payload))))
  | (PlayerTeam, true | false) => Some(Packetv1405.Lazy.PlayerTeam(lazy(Packetv1405.PlayerTeam.parse(payload))))
  | (SignRead, true) => None
  | (SignRead, false) => Some(Packetv1405.Lazy.SignRead(lazy(Packetv1405.SignRead.parse(payload))))
  | (SignNew, true | false) => Some(Packetv1405.Lazy.SignNew(lazy(Packetv1405.SignNew.parse(payload))))
  | (LiquidSet, true | false) => Some(Packetv1405.Lazy.LiquidSet(lazy(Packetv1405.LiquidSet.parse(payload))))
  | (PlayerSpawnSelf, false) => None
  | (PlayerSpawnSelf, true) =>
  ...
  | (ChestUnlock, true | false) => Some(Packetv1405.Lazy.ChestUnlock(lazy(Packetv1405.ChestUnlock.parse(payload))))
  | (NpcBuffAdd, true | false) => Some(Packetv1405.Lazy.NpcBuffAdd(lazy(Packetv1405.NpcBuffAdd.parse(payload))))
  | (NpcBuffUpdate, false) => None
  | (NpcBuffUpdate, true) =>
  ...
  | (HarpPlay, true | false) => Some(Packetv1405.Lazy.HarpPlay(lazy(Packetv1405.HarpPlay.parse(payload))))
  | (SwitchHit, true | false) => Some(Packetv1405.Lazy.SwitchHit(lazy(Packetv1405.SwitchHit.parse(payload))))
  | (NpcHomeUpdate, true | false) =>
  ...
  | (PlayerDodge, true | false) => Some(Packetv1405.Lazy.PlayerDodge(lazy(Packetv1405.PlayerDodge.parse(payload))))
  | (PaintTile, true | false) => Some(Packetv1405.Lazy.PaintTile(lazy(Packetv1405.PaintTile.parse(payload))))
  | (PaintWall, true | false) => Some(Packetv1405.Lazy.PaintWall(lazy(Packetv1405.PaintWall.parse(payload))))
  | (Teleport, true | false) => Some(Packetv1405.Lazy.Teleport(lazy(Packetv1405.Teleport.parse(payload))))
  | (PlayerHealOther, true | false) =>
  ...
  | (ClientUuid, true) => None
  | (ClientUuid, false) => Some(Packetv1405.Lazy.ClientUuid(lazy(Packetv1405.ClientUuid.parse(payload))))
  | (ChestName, true | false) => Some(Packetv1405.Lazy.ChestName(lazy(Packetv1405.ChestName.parse(payload))))
  | (CatchNpc, true) => None
  | (CatchNpc, false) => Some(Packetv1405.Lazy.CatchNpc(lazy(Packetv1405.CatchNpc.parse(payload))))
  | (ReleaseNpc, true) => None
  | (ReleaseNpc, false) => Some(Packetv1405.Lazy.ReleaseNpc(lazy(Packetv1405.ReleaseNpc.parse(payload))))
  | (TravellingMerchantInventory, false) => None
  | (TravellingMerchantInventory, true) =>
    Some(Packetv1405.Lazy.TravellingMerchantInventory(lazy(Packetv1405.TravellingMerchantInventory.parse(payload))))
  | (TeleportationPotion, true | false) =>
    Some(Packetv1405.Lazy.TeleportationPotion(lazy(Packetv1405.TeleportationPotion.parse(payload))))
  | (AnglerQuest, false) => None
  | (AnglerQuest, true) => Some(Packetv1405.Lazy.AnglerQuest(lazy(Packetv1405.AnglerQuest.parse(payload))))
  | (AnglerQuestComplete, true) => None
  | (AnglerQuestComplete, false) =>
    Some(Packetv1405.Lazy.AnglerQuestComplete(lazy(Packetv1405.AnglerQuestComplete.parse(payload))))
  | (AnglerQuestsCompletedAmount, true) => None
  | (AnglerQuestsCompletedAmount, false) =>
    Some(Packetv1405.Lazy.AnglerQuestsCompletedAmount(lazy(Packetv1405.AnglerQuestsCompletedAmount.parse(payload))))
  | (TemporaryAnimationCreate, false) => None
  | (TemporaryAnimationCreate, true) =>
    Some(Packetv1405.Lazy.TemporaryAnimationCreate(lazy(Packetv1405.TemporaryAnimationCreate.parse(payload))))
  | (InvasionProgressReport, false) => None
  | (InvasionProgressReport, true) =>
    Some(Packetv1405.Lazy.InvasionProgressReport(lazy(Packetv1405.InvasionProgressReport.parse(payload))))
  | (ObjectPlace, true | false) => Some(Packetv1405.Lazy.ObjectPlace(lazy(Packetv1405.ObjectPlace.parse(payload))))
  | (PlayerChestIndexSync, false) => None
  | (PlayerChestIndexSync, true) =>
    Some(Packetv1405.Lazy.PlayerChestIndexSync(lazy(Packetv1405.PlayerChestIndexSync.parse(payload))))
  | (CombatNumberCreate, false) => None
  | (CombatNumberCreate, true) =>
  ...
  | (NpcKillCount, false) => None
  | (NpcKillCount, true) => Some(Packetv1405.Lazy.NpcKillCount(lazy(Packetv1405.NpcKillCount.parse(payload))))
  | (PlayerStealth, true | false) =>
    Some(Packetv1405.Lazy.PlayerStealth(lazy(Packetv1405.PlayerStealth.parse(payload))))
  | (ItemForceIntoNearestChest, true) => None
  | (ItemForceIntoNearestChest, false) =>
    Some(Packetv1405.Lazy.ItemForceIntoNearestChest(lazy(Packetv1405.ItemForceIntoNearestChest.parse(payload))))
  | (TileEntityUpdate, false) => None
  | (TileEntityUpdate, true) =>
  ...
  | (ItemDropInstancedUpdate, true | false) =>
    Some(Packetv1405.Lazy.ItemDropInstancedUpdate(lazy(Packetv1405.ItemDropInstancedUpdate.parse(payload))))
  | (EmoteBubble, false) => None
  | (EmoteBubble, true) => Some(Packetv1405.Lazy.EmoteBubble(lazy(Packetv1405.EmoteBubble.parse(payload))))
  | (ExtraValueSync, true | false) =>
  ...
  | (PortalKill, true) => None
  | (PortalKill, false) => Some(Packetv1405.Lazy.PortalKill(lazy(Packetv1405.PortalKill.parse(payload))))
  | (PlayerTeleportPortal, true | false) =>
    Some(Packetv1405.Lazy.PlayerTeleportPortal(lazy(Packetv1405.PlayerTeleportPortal.parse(payload))))
  | (NpcKilledNotification, false) => None
  | (NpcKilledNotification, true) =>
    Some(Packetv1405.Lazy.NpcKilledNotification(lazy(Packetv1405.NpcKilledNotification.parse(payload))))
  | (EventNotification, false) => None
  | (EventNotification, true) =>
  ...
  | (ShieldStrengthsUpdate, false) => None
  | (ShieldStrengthsUpdate, true) =>
    Some(Packetv1405.Lazy.ShieldStrengthsUpdate(lazy(Packetv1405.ShieldStrengthsUpdate.parse(payload))))
  | (NebulaLevelUp, true | false) =>
  ...
  | (NpcShopItem, false) => None
  | (NpcShopItem, true) => Some(Packetv1405.Lazy.NpcShopItem(lazy(Packetv1405.NpcShopItem.parse(payload))))
  | (GemLockToggle, true) => None
  | (GemLockToggle, false) =>
  ...
  | (MassWireOperationPay, false) => None
  | (MassWireOperationPay, true) =>
    Some(Packetv1405.Lazy.MassWireOperationPay(lazy(Packetv1405.MassWireOperationPay.parse(payload))))
  | (PartyToggle, true) => None
  | (PartyToggle, false) => Some(Packetv1405.Lazy.PartyToggle(lazy(Packetv1405.PartyToggle.parse(payload))))
  | (TreeGrowFx, true | false) => Some(Packetv1405.Lazy.TreeGrowFx(lazy(Packetv1405.TreeGrowFx.parse(payload))))
  | (CrystalInvasionStart, true) => None
  | (CrystalInvasionStart, false) =>
    Some(Packetv1405.Lazy.CrystalInvasionStart(lazy(Packetv1405.CrystalInvasionStart.parse(payload))))
  | (CrystalInvasionWipeAll, false) => None
  | (CrystalInvasionWipeAll, true) =>
    Some(Packetv1405.Lazy.CrystalInvasionWipeAll(lazy(Packetv1405.CrystalInvasionWipeAll.parse(payload))))
  | (MinionAttackTargetUpdate, true | false) =>
    Some(Packetv1405.Lazy.MinionAttackTargetUpdate(lazy(Packetv1405.MinionAttackTargetUpdate.parse(payload))))
  | (CrystalInvasionSendWaitTime, false) => None
  | (CrystalInvasionSendWaitTime, true) =>
    Some(Packetv1405.Lazy.CrystalInvasionSendWaitTime(lazy(Packetv1405.CrystalInvasionSendWaitTime.parse(payload))))
  | (PlayerDamage, true | false) => Some(Packetv1405.Lazy.PlayerDamage(lazy(Packetv1405.PlayerDamage.parse(payload))))
  | (PlayerDeath, true | false) => Some(Packetv1405.Lazy.PlayerDeath(lazy(Packetv1405.PlayerDeath.parse(payload))))
  | (CombatTextCreate, false) => None
  | (CombatTextCreate, true) =>
  ...
  | (TileEntityDisplayDollItemSync, true | false) =>
    Some(Packetv1405.Lazy.TileEntityDisplayDollItemSync(lazy(Packetv1405.TileEntityDisplayDollItemSync.parse(payload))))
  | (TileEntityInteractionRequest, true | false) =>
    Some(Packetv1405.Lazy.TileEntityInteractionRequest(lazy(Packetv1405.TileEntityInteractionRequest.parse(payload))))
  | (WeaponsRackTryPlacing, true) => None
  | (WeaponsRackTryPlacing, false) =>
    Some(Packetv1405.Lazy.WeaponsRackTryPlacing(lazy(Packetv1405.WeaponsRackTryPlacing.parse(payload))))
  | (TileEntityHatRackItemSync, true | false) =>
    Some(Packetv1405.Lazy.TileEntityHatRackItemSync(lazy(Packetv1405.TileEntityHatRackItemSync.parse(payload))))
  | (TilePickingSync, true | false) =>
  ...
  | (ClientFinishConnectingToServer, false) => None
  | (ClientFinishConnectingToServer, true) =>
    Some(Packetv1405.Lazy.ClientFinishConnectingToServer(lazy(Packetv1405.ClientFinishConnectingToServer.parse(payload))))
  | (NpcFishOut, true) => None
  | (NpcFishOut, false) => Some(Packetv1405.Lazy.NpcFishOut(lazy(Packetv1405.NpcFishOut.parse(payload))))
  | (NpcTamper, false) => None
  ...
  | (FoodPlatterTryPlacing, true) => None
  | (FoodPlatterTryPlacing, false) =>
    Some(Packetv1405.Lazy.FoodPlatterTryPlacing(lazy(Packetv1405.FoodPlatterTryPlacing.parse(payload))))
  | (PlayerLuckFactorsUpdate, true | false) =>
    Some(Packetv1405.Lazy.PlayerLuckFactorsUpdate(lazy(Packetv1405.PlayerLuckFactorsUpdate.parse(payload))))
  | (PlayerDead, false) => None
  | (PlayerDead, true) => Some(Packetv1405.Lazy.PlayerDead(lazy(Packetv1405.PlayerDead.parse(payload))))
  | (CavernMonsterTypeSync, true | false) =>
    Some(Packetv1405.Lazy.CavernMonsterTypeSync(lazy(Packetv1405.CavernMonsterTypeSync.parse(payload))))
  | (NpcBuffRemovalRequest, true) => None
  | (NpcBuffRemovalRequest, false) =>
    Some(Packetv1405.Lazy.NpcBuffRemovalRequest(lazy(Packetv1405.NpcBuffRemovalRequest.parse(payload))))
  | (ClientSyncedInventory, true) => None
  | (ClientSyncedInventory, false) =>
    Some(Packetv1405.Lazy.ClientSyncedInventory(lazy(Packetv1405.ClientSyncedInventory.parse(payload))))
  | (CountsAsHostForGameplaySet, false) => None
  | (CountsAsHostForGameplaySet, true) =>
    Some(Packetv1405.Lazy.CountsAsHostForGameplaySet(lazy(Packetv1405.CountsAsHostForGameplaySet.parse(payload))))
  }
...
let parseAsLatestLazy: IParser.parseLazy<Packet.Lazy.t> = (~buffer: NodeJs.Buffer.t, ~fromServer: bool) => {

...
module PlayerInfo = PacketV1456_PlayerInfo
module PlayerInventorySlot = PacketV1456_PlayerInventorySlot
module WorldDataRequest = PacketV1449_WorldDataRequest
module WorldInfo = PacketV1456_WorldInfo
module InitialTileSectionsRequest = PacketV1456_InitialTileSectionsRequest
...
module PlayerUpdate = PacketV1456_PlayerUpdate
...
module ItemOwner = PacketV1456_ItemOwner
module NpcUpdate = PacketV1456_NpcUpdate
...
module ProjectileDestroy = PacketV1449_ProjectileDestroy
...
module ManaEffect = PacketV1449_ManaEffect
module PlayerTeam = PacketV1449_PlayerTeam
module SignRead = PacketV1449_SignRead
...
module PlayerBuffsSet = PacketV1456_PlayerBuffsSet
...
module NpcBuffUpdate = PacketV1456_NpcBuffUpdate
...
module HarpPlay = PacketV1449_HarpPlay
...
module TemporaryAnimationCreate = PacketV1449_TemporaryAnimationCreate
module InvasionProgressReport = PacketV1449_InvasionProgressReport
...
module NetModuleLoad = PacketV1456_NetModuleLoad
...
module ItemDropInstancedUpdate = PacketV1449_ItemDropInstancedUpdate
...
module Unused = PacketV1456_DebugCommand
...
module EventNotification = PacketV1449_EventNotification
module MinionTargetUpdate = PacketV1449_MinionTargetUpdate
module NpcTeleportPortal = PacketV1449_NpcTeleportPortal
module ShieldStrengthsUpdate = PacketV1449_ShieldStrengthsUpdate
module NebulaLevelUp = PacketV1449_NebulaLevelUp
module MoonLordCountdown = PacketV1449_MoonLordCountdown
module NpcShopItem = PacketV1449_NpcShopItem
module GemLockToggle = PacketV1449_GemLockToggle
module SmokePoof = PacketV1449_SmokePoof
module ChatMessageSmart = PacketV1449_ChatMessageSmart
module WiredCannonShot = PacketV1449_WiredCannonShot
module MassWireOperation = PacketV1449_MassWireOperation
module MassWireOperationPay = PacketV1449_MassWireOperationPay
module PartyToggle = PacketV1449_PartyToggle
module TreeGrowFx = PacketV1449_TreeGrowFx
module CrystalInvasionStart = PacketV1449_CrystalInvasionStart
module CrystalInvasionWipeAll = PacketV1449_CrystalInvasionWipeAll
module MinionAttackTargetUpdate = PacketV1449_MinionAttackTargetUpdate
module CrystalInvasionSendWaitTime = PacketV1449_CrystalInvasionSendWaitTime
module PlayerDamage = PacketV1449_PlayerDamage
...
module TileEntityDisplayDollItemSync = PacketV1456_TileEntityDisplayDollItemSync
...
module TilePickingSync = PacketV1449_TilePickingSync
module RevengeMarkerSync = PacketV1449_RevengeMarkerSync
module RevengeMarkerRemove = PacketV1449_RevengeMarkerRemove
module GolfBallLandInCup = PacketV1449_GolfBallLandInCup
module ClientFinishConnectingToServer = PacketV1449_ClientFinishConnectingToServer
module NpcFishOut = PacketV1449_NpcFishOut
...
module PlayerLuckFactorsUpdate = PacketV1456_PlayerLuckFactorsUpdate
...
module ClientSyncedInventory = PacketV1449_ClientSyncedInventory
module CountsAsHostForGameplaySet = PacketV1449_CountsAsHostForGameplaySet
module CreditsOrSlimeTransform = PacketV1449_CreditsOrSlimeTransform
module LucyAxeMessage = PacketV1449_LucyAxeMessage
module PiggyBankVoidLensUpdate = PacketV1449_PiggyBankVoidLensUpdate
...
module ShimmerEffectOrCoinLuck = PacketV1456_ShimmerEffectOrCoinLuck
module LoadoutSwitch = PacketV1449_LoadoutSwitch
module ItemDropProtectedUpdate = PacketV1449_ItemDropProtectedUpdate
module DeadCellsDisplayJarTryPlacing = PacketV1456_DeadCellsDisplayJarTryPlacing
module PlayerSpectate = PacketV1456_PlayerSpectate
module ItemDropClear = PacketV1456_ItemDropClear
module PlayerItemUseSound = PacketV1456_PlayerItemUseSound
module NpcHurtByDebuff = PacketV1456_NpcHurtByDebuff
module Ping = PacketV1456_Ping
module ChestResize = PacketV1456_ChestResize
module LeashedEntityAnchorInsertItem = PacketV1456_LeashedEntityAnchorInsertItem
module PlayerTeamUpdate = PacketV1456_PlayerTeamUpdate
module PlayerTeamSwapSpawn = PacketV1456_PlayerTeamSwapSpawn
...
module ServerInfo = PacketV1456_ServerInfo
module PlayerPlatformInfo = PacketV1456_PlayerPlatformInfo
...
let packetTypeOf = (packet: t): PacketTypeV1456.t =>
  switch packet {
  | ConnectRequest(_) => PacketTypeV1456.ConnectRequest
  | Disconnect(_) => PacketTypeV1456.Disconnect
  | PlayerSlotSet(_) => PacketTypeV1456.PlayerSlotSet
  | PlayerInfo(_) => PacketTypeV1456.PlayerInfo
  | PlayerInventorySlot(_) => PacketTypeV1456.PlayerInventorySlot
  | WorldDataRequest(_) => PacketTypeV1456.WorldDataRequest
  | WorldInfo(_) => PacketTypeV1456.WorldInfo
  | InitialTileSectionsRequest(_) => PacketTypeV1456.InitialTileSectionsRequest
  | Status(_) => PacketTypeV1456.Status
  | TileSectionSend(_) => PacketTypeV1456.TileSectionSend
  | TileSectionFrame(_) => PacketTypeV1456.TileSectionFrame
  | PlayerSpawn(_) => PacketTypeV1456.PlayerSpawn
  | PlayerUpdate(_) => PacketTypeV1456.PlayerUpdate
  | PlayerActive(_) => PacketTypeV1456.PlayerActive
  | PlayerHealth(_) => PacketTypeV1456.PlayerHealth
  | TileModify(_) => PacketTypeV1456.TileModify
  | TimeSet(_) => PacketTypeV1456.TimeSet
  | DoorUse(_) => PacketTypeV1456.DoorUse
  | TileSquareSend(_) => PacketTypeV1456.TileSquareSend
  | ItemDropUpdate(_) => PacketTypeV1456.ItemDropUpdate
  | ItemOwner(_) => PacketTypeV1456.ItemOwner
  | NpcUpdate(_) => PacketTypeV1456.NpcUpdate
  | NpcItemStrike(_) => PacketTypeV1456.NpcItemStrike
  | ProjectileSync(_) => PacketTypeV1456.ProjectileSync
  | NpcStrike(_) => PacketTypeV1456.NpcStrike
  | ProjectileDestroy(_) => PacketTypeV1456.ProjectileDestroy
  | PvpToggle(_) => PacketTypeV1456.PvpToggle
  | ChestOpen(_) => PacketTypeV1456.ChestOpen
  | ChestItem(_) => PacketTypeV1456.ChestItem
  | ActiveContainerSync(_) => PacketTypeV1456.ActiveContainerSync
  | ChestPlace(_) => PacketTypeV1456.ChestPlace
  | HealEffect(_) => PacketTypeV1456.HealEffect
  | Zones(_) => PacketTypeV1456.Zones
  | PasswordRequired(_) => PacketTypeV1456.PasswordRequired
  | PasswordSend(_) => PacketTypeV1456.PasswordSend
  | ItemOwnerRemove(_) => PacketTypeV1456.ItemOwnerRemove
  | NpcTalk(_) => PacketTypeV1456.NpcTalk
  | PlayerAnimation(_) => PacketTypeV1456.PlayerAnimation
  | PlayerMana(_) => PacketTypeV1456.PlayerMana
  | ManaEffect(_) => PacketTypeV1456.ManaEffect
  | PlayerTeam(_) => PacketTypeV1456.PlayerTeam
  | SignRead(_) => PacketTypeV1456.SignRead
  | SignNew(_) => PacketTypeV1456.SignNew
  | LiquidSet(_) => PacketTypeV1456.LiquidSet
  | PlayerSpawnSelf(_) => PacketTypeV1456.PlayerSpawnSelf
  | PlayerBuffsSet(_) => PacketTypeV1456.PlayerBuffsSet
  | NpcSpecialEffect(_) => PacketTypeV1456.NpcSpecialEffect
  | ChestOrTempleUnlock(_) => PacketTypeV1456.ChestOrTempleUnlock
  | NpcBuffAdd(_) => PacketTypeV1456.NpcBuffAdd
  | NpcBuffUpdate(_) => PacketTypeV1456.NpcBuffUpdate
  | PlayerBuffAdd(_) => PacketTypeV1456.PlayerBuffAdd
  | NpcNameUpdate(_) => PacketTypeV1456.NpcNameUpdate
  | GoodEvilUpdate(_) => PacketTypeV1456.GoodEvilUpdate
  | HarpPlay(_) => PacketTypeV1456.HarpPlay
  | SwitchHit(_) => PacketTypeV1456.SwitchHit
  | NpcHomeUpdate(_) => PacketTypeV1456.NpcHomeUpdate
  | BossOrInvasionSpawn(_) => PacketTypeV1456.BossOrInvasionSpawn
  | PlayerDodge(_) => PacketTypeV1456.PlayerDodge
  | TilePaint(_) => PacketTypeV1456.TilePaint
  | WallPaint(_) => PacketTypeV1456.WallPaint
  | Teleport(_) => PacketTypeV1456.Teleport
  | PlayerHealOther(_) => PacketTypeV1456.PlayerHealOther
  | DimensionsUpdate(_) => PacketTypeV1456.DimensionsUpdate
  | ClientUuid(_) => PacketTypeV1456.ClientUuid
  | ChestName(_) => PacketTypeV1456.ChestName
  | NpcCatch(_) => PacketTypeV1456.NpcCatch
  | NpcRelease(_) => PacketTypeV1456.NpcRelease
  | TravellingMerchantInventory(_) => PacketTypeV1456.TravellingMerchantInventory
  | TeleportationPotion(_) => PacketTypeV1456.TeleportationPotion
  | AnglerQuest(_) => PacketTypeV1456.AnglerQuest
  | AnglerQuestComplete(_) => PacketTypeV1456.AnglerQuestComplete
  | AnglerQuestsCompletedAmount(_) => PacketTypeV1456.AnglerQuestsCompletedAmount
  | TemporaryAnimationCreate(_) => PacketTypeV1456.TemporaryAnimationCreate
  | InvasionProgressReport(_) => PacketTypeV1456.InvasionProgressReport
  | ObjectPlace(_) => PacketTypeV1456.ObjectPlace
  | PlayerChestIndexSync(_) => PacketTypeV1456.PlayerChestIndexSync
  | CombatNumberCreate(_) => PacketTypeV1456.CombatNumberCreate
  | NetModuleLoad(_) => PacketTypeV1456.NetModuleLoad
  | NpcKillCount(_) => PacketTypeV1456.NpcKillCount
  | PlayerStealth(_) => PacketTypeV1456.PlayerStealth
  | ItemForceIntoNearestChest(_) => PacketTypeV1456.ItemForceIntoNearestChest
  | TileEntityUpdate(_) => PacketTypeV1456.TileEntityUpdate
  | TileEntityPlace(_) => PacketTypeV1456.TileEntityPlace
  | ItemDropModify(_) => PacketTypeV1456.ItemDropModify
  | ItemFramePlace(_) => PacketTypeV1456.ItemFramePlace
  | ItemDropInstancedUpdate(_) => PacketTypeV1456.ItemDropInstancedUpdate
  | EmoteBubble(_) => PacketTypeV1456.EmoteBubble
  | ExtraValueSync(_) => PacketTypeV1456.ExtraValueSync
  | SocialHandshake(_) => PacketTypeV1456.SocialHandshake
  | Unused(_) => PacketTypeV1456.Unused
  | PortalKill(_) => PacketTypeV1456.PortalKill
  | PlayerTeleportPortal(_) => PacketTypeV1456.PlayerTeleportPortal
  | NpcKilledNotification(_) => PacketTypeV1456.NpcKilledNotification
  | EventNotification(_) => PacketTypeV1456.EventNotification
  | MinionTargetUpdate(_) => PacketTypeV1456.MinionTargetUpdate
  | NpcTeleportPortal(_) => PacketTypeV1456.NpcTeleportPortal
  | ShieldStrengthsUpdate(_) => PacketTypeV1456.ShieldStrengthsUpdate
  | NebulaLevelUp(_) => PacketTypeV1456.NebulaLevelUp
  | MoonLordCountdown(_) => PacketTypeV1456.MoonLordCountdown
  | NpcShopItem(_) => PacketTypeV1456.NpcShopItem
  | GemLockToggle(_) => PacketTypeV1456.GemLockToggle
  | SmokePoof(_) => PacketTypeV1456.SmokePoof
  | ChatMessageSmart(_) => PacketTypeV1456.ChatMessageSmart
  | WiredCannonShot(_) => PacketTypeV1456.WiredCannonShot
  | MassWireOperation(_) => PacketTypeV1456.MassWireOperation
  | MassWireOperationPay(_) => PacketTypeV1456.MassWireOperationPay
  | PartyToggle(_) => PacketTypeV1456.PartyToggle
  | TreeGrowFx(_) => PacketTypeV1456.TreeGrowFx
  | CrystalInvasionStart(_) => PacketTypeV1456.CrystalInvasionStart
  | CrystalInvasionWipeAll(_) => PacketTypeV1456.CrystalInvasionWipeAll
  | MinionAttackTargetUpdate(_) => PacketTypeV1456.MinionAttackTargetUpdate
  | CrystalInvasionSendWaitTime(_) => PacketTypeV1456.CrystalInvasionSendWaitTime
  | PlayerDamage(_) => PacketTypeV1456.PlayerDamage
  | PlayerDeath(_) => PacketTypeV1456.PlayerDeath
  | CombatTextCreate(_) => PacketTypeV1456.CombatTextCreate
  | Emoji(_) => PacketTypeV1456.Emoji
  | TileEntityDisplayDollItemSync(_) => PacketTypeV1456.TileEntityDisplayDollItemSync
  | TileEntityInteractionRequest(_) => PacketTypeV1456.TileEntityInteractionRequest
  | WeaponsRackTryPlacing(_) => PacketTypeV1456.WeaponsRackTryPlacing
  | TileEntityHatRackItemSync(_) => PacketTypeV1456.TileEntityHatRackItemSync
  | TilePickingSync(_) => PacketTypeV1456.TilePickingSync
  | RevengeMarkerSync(_) => PacketTypeV1456.RevengeMarkerSync
  | RevengeMarkerRemove(_) => PacketTypeV1456.RevengeMarkerRemove
  | GolfBallLandInCup(_) => PacketTypeV1456.GolfBallLandInCup
  | ClientFinishConnectingToServer(_) => PacketTypeV1456.ClientFinishConnectingToServer
  | NpcFishOut(_) => PacketTypeV1456.NpcFishOut
  | NpcTamper(_) => PacketTypeV1456.NpcTamper
  | LegacySoundPlay(_) => PacketTypeV1456.LegacySoundPlay
  | FoodPlatterTryPlacing(_) => PacketTypeV1456.FoodPlatterTryPlacing
  | PlayerLuckFactorsUpdate(_) => PacketTypeV1456.PlayerLuckFactorsUpdate
  | PlayerDead(_) => PacketTypeV1456.PlayerDead
  | CavernMonsterTypeSync(_) => PacketTypeV1456.CavernMonsterTypeSync
  | NpcBuffRemovalRequest(_) => PacketTypeV1456.NpcBuffRemovalRequest
  | ClientSyncedInventory(_) => PacketTypeV1456.ClientSyncedInventory
  | CountsAsHostForGameplaySet(_) => PacketTypeV1456.CountsAsHostForGameplaySet
  | CreditsOrSlimeTransform(_) => PacketTypeV1456.CreditsOrSlimeTransform
  | LucyAxeMessage(_) => PacketTypeV1456.LucyAxeMessage
  | PiggyBankVoidLensUpdate(_) => PacketTypeV1456.PiggyBankVoidLensUpdate
  | DungeonDefendersEventAttemptSkipWait(_) => PacketTypeV1456.DungeonDefendersEventAttemptSkipWait
  | HaveDryadDoStardewAnimation(_) => PacketTypeV1456.HaveDryadDoStardewAnimation
  | ItemDropShimmeredUpdate(_) => PacketTypeV1456.ItemDropShimmeredUpdate
  | ShimmerEffectOrCoinLuck(_) => PacketTypeV1456.ShimmerEffectOrCoinLuck
  | LoadoutSwitch(_) => PacketTypeV1456.LoadoutSwitch
  | ItemDropProtectedUpdate(_) => PacketTypeV1456.ItemDropProtectedUpdate
  | DeadCellsDisplayJarTryPlacing(_) => PacketTypeV1456.DeadCellsDisplayJarTryPlacing
  | PlayerSpectate(_) => PacketTypeV1456.PlayerSpectate
  | ItemDropClear(_) => PacketTypeV1456.ItemDropClear
  | PlayerItemUseSound(_) => PacketTypeV1456.PlayerItemUseSound
  | NpcHurtByDebuff(_) => PacketTypeV1456.NpcHurtByDebuff
  | Ping(_) => PacketTypeV1456.Ping
  | ChestResize(_) => PacketTypeV1456.ChestResize
  | LeashedEntityAnchorInsertItem(_) => PacketTypeV1456.LeashedEntityAnchorInsertItem
  | PlayerTeamUpdate(_) => PacketTypeV1456.PlayerTeamUpdate
  | PlayerTeamSwapSpawn(_) => PacketTypeV1456.PlayerTeamSwapSpawn
  | SectionRequest(_) => PacketTypeV1456.SectionRequest
  | ItemDropPosition(_) => PacketTypeV1456.ItemDropPosition
  | HostToken(_) => PacketTypeV1456.HostToken
  | ServerInfo(_) => PacketTypeV1456.ServerInfo
  | PlayerPlatformInfo(_) => PacketTypeV1456.PlayerPlatformInfo
  }

let directionOfPacketType = (packetType: PacketTypeV1456.t): direction =>
  switch packetType {
  | ConnectRequest
  | WorldDataRequest
...
let guardDirection = (packetType: PacketTypeV1456.t, fromServer: bool): option<
  ISerializer.toBufferResult,
> =>
  switch (directionOfPacketType(packetType), fromServer) {
  | (Both, _) => None
  | (ServerOnly, true) => None
  | (ClientOnly, false) => None
  | (_, _) => Some(directionError(packetType, fromServer))
  }
...
module LazyPacket = {
  ...
  let toPacketName = (packet: t): string => packet->packetTypeOf->PacketTypeV1456.packetName
}

let toBuffer = (packet: t, fromServer: bool): ISerializer.toBufferResult => {
  let packetType = packetTypeOf(packet)
  switch guardDirection(packetType, fromServer) {
  | Some(err) => err
  | None =>
    switch packet {
